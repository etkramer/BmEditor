...
namespace MemoryProfiler2
{
	public partial class MainWindow : Form
	{
        ...
        /** List of file offsets to create custom snapshots for */
        private List<int> CustomSnapshots;
        ...
        /**
		 * Returns the allocation count of the far left point on the timeline chart
		 */
        private long GetStartingAllocationCount()
        {
            if (DiffStartComboBox.SelectedIndex <= DiffEndComboBox.SelectedIndex)
            {
                ...
                return SnapshotList[DiffStartComboBox.SelectedIndex-1].AllocationCount;
            }
            else
            {
                ...
                return SnapshotList[DiffEndComboBox.SelectedIndex-1].AllocationCount;
            }
        }
		...
		private void ParseFile( string InCurrentFilename )
		{
			...
			if (CurrentFilename != "")
			{
				try
				{
                    ...
                    {
                        SnapshotList = FStreamParser.Parse(this, BGWorker, CustomSnapshots);
                    };
        ...
        private void TimeLineChart_SelectionRangeChanged(object sender, System.Windows.Forms.DataVisualization.Charting.CursorEventArgs Event)
        {
            if (Event.Axis.AxisName == System.Windows.Forms.DataVisualization.Charting.AxisName.X)
            {
                ...
                else
                {
                    ...
                    FTimeLineChartView.AddCustomSnapshot(TimeLineChart, Event);
