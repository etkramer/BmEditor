	...
	public class Localise
	{
		...
		public void Init( string Language, string ParentLanguage )
		{
			...
			case "FRA":
				...
				Dictionary.Add( "PrivacyStatement2", "Lisez notre déclaration de confidentialité : http://udk.com/privacy" );
				...
				Dictionary.Add( "RedistVCRedistHeader", "Éléments redistribuables de Visual Studio 2008" );
				Dictionary.Add( "RedistDXRedistHeader", "Microsoft DirectX 9.0c" );
				Dictionary.Add( "RedistChartingToolsHeader", "Outils de création de graphiques Microsoft" );
				Dictionary.Add( "RedistAMDCPUHeader", "Pilotes pour microprocesseurs AMD (XP uniquement)" );

				Dictionary.Add( "RedistVCRedistContent", "Accédez à de la documentation et à des ressources UDK gratuites à l'adresse http://www.udk.com/documentation." );
				...
				Dictionary.Add( "RedistChartingToolsContent", "L'UDK s'adresse à tous ceux qui apprennent ou utilisent une technologie de moteur de jeu 3D, des étudiants aux développeurs. Il ne connaît aucune limite." );
				...
				Dictionary.Add( "RedistChartingToolsFail", "Échec de l'installation de MSChart." );
				Dictionary.Add( "RedistAMDCPUFail", "Échec de l'installation des pilotes pour microprocesseurs AMD." );

				Dictionary.Add( "IFDependsFailed", "Les dépendances n'ont pas été installées. Exécutez « UDK-INSTALL-FOLDER/Binaries/Windows/UE3Redist.exe »." );
				...
				Dictionary.Add( "RedistVCRedistContentTech", "Microsoft Visual C++ 2008 SP1 Redistributable Package (x86) installe des composants d'exécution des bibliothèques Visual C++ nécessaires à l'exécution d'applications développées avec Visual C++ SP1 sur un ordinateur ne contenant pas Visual C++ 2008 SP1. Ce package installe des composants d'exécution des bibliothèques C Runtime (CRT), Standard C++, ATL, MFC, OpenMP et MSDIA." );
				...
				Dictionary.Add( "RedistChartingToolsContentTech", "Microsoft Chart Controls pour Microsoft .NET Framework 3.5 SP1 installe de nouveaux assemblages contenant ASP.NET et Windows Forms Chart Controls." );
			...
			case "ITA":
				...
				Dictionary.Add( "PrivacyStatement2", "Leggi la nostra politica di riservatezza: http://udk.com/privacy" );
				...
				Dictionary.Add( "RedistVCRedistHeader", "Redistribuibili Visual Studio 2008" );
				Dictionary.Add( "RedistDXRedistHeader", "Microsoft DirectX 9.0c" );
				Dictionary.Add( "RedistChartingToolsHeader", "Microsoft Charting Tools" );
				Dictionary.Add( "RedistAMDCPUHeader", "Driver AMD CPU (unico passo per XP)" );

				Dictionary.Add( "RedistVCRedistContent", "Accedi gratuitamente alla documentazione e alle risorse di supporto di UDK su http://www.udk.com/documentation" );
				...
				Dictionary.Add( "RedistChartingToolsContent", "UDK è adatto a chiunque usi o stia imparando a usare la tecnologia dei motori 3D, dagli sviluppatori dei giochi agli studenti. Senza alcun limite." );
				Dictionary.Add( "RedistAMDCPUContent", "" );
				...
				Dictionary.Add( "RedistChartingToolsFail", "Impossibile installare MSChart." );
				Dictionary.Add( "RedistAMDCPUFail", "Impossibile installare driver AMD CPU." );

				Dictionary.Add( "IFDependsFailed", "Le dipendenze non sono state installate; eseguire 'UDK-INSTALL-FOLDER/Binaries/Windows/UE3Redist.exe'" );
				...
				Dictionary.Add( "RedistChartingToolsContentTech", "Microsoft Chart Controls per Microsoft .NET Framework 3.5 SP1 installerà nuovi assembly che contengono ASP.NET e Windows Forms Chart Controls." );
			...
			case "DEU":
				...
				Dictionary.Add( "PrivacyStatement2", "Lesen Sie unsere Datenschutzrichtlinien: http://udk.com/privacy" );
				...
				Dictionary.Add( "RedistVCRedistHeader", "Redistributables für Visual Studio 2008" );
				Dictionary.Add( "RedistDXRedistHeader", "Microsoft DirectX 9.0c" );
				Dictionary.Add( "RedistChartingToolsHeader", "Microsoft-Diagrammwerkzeuge" );
				Dictionary.Add( "RedistAMDCPUHeader", "AMD CPU-Treiber (nur für XP)" );

				Dictionary.Add( "RedistVCRedistContent", "Unter http://www.udk.com/documentation finden Sie Gratis-Referenzwerke und -Hilfsmittel für das UDK." );
				...
				Dictionary.Add( "RedistChartingToolsContent", "Das UDK ist für alle gedacht, die mehr über die Technik hinter den 3-D-Spielengines erfahren wollen oder diese Technologie bereits nutzen. Das UDK ist ohne Einschränkungen für alle Anwender vom Spieleentwickler bis hin zum Schüler geeignet." );
				Dictionary.Add( "RedistAMDCPUContent", "" );
				...
				Dictionary.Add( "RedistChartingToolsFail", "Installation von MSChart fehlgeschlagen." );
				Dictionary.Add( "RedistAMDCPUFail", "Installation der AMD CPU-Treiber fehlgeschlagen." );

				Dictionary.Add( "IFDependsFailed", "Die abhängigen Komponenten wurden nicht installiert – bitte 'UDK-INSTALL-FOLDER/Binaries/Windows/UE3Redist.exe' ausführen" );
				...
				Dictionary.Add( "RedistChartingToolsContentTech", "Microsoft Chart Controls für Microsoft .NET Framework 3.5 SP1 installiert neue Komponenten, welche die ASP.NET- und Windows Forms-Diagrammsteuerung enthalten." );
			...
			case "ESN":
				...
				Dictionary.Add( "PrivacyStatement2", "Lea nuestra política de privacidad: http://udk.com/privacy" );
				...
				Dictionary.Add( "RedistVCRedistHeader", "Redistribuibles de Visual Studio 2008" );
				Dictionary.Add( "RedistDXRedistHeader", "Microsoft DirectX 9.0c" );
				Dictionary.Add( "RedistChartingToolsHeader", "Microsoft Charting Tools" );
				Dictionary.Add( "RedistAMDCPUHeader", "AMD CPU Drivers (solo para XP)" );

				Dictionary.Add( "RedistVCRedistContent", "Acceda de manera gratuita a los recursos y a la documentación de ayuda de UDK en http://www.udk.com/documentation" );
				...
				Dictionary.Add( "RedistChartingToolsContent", "UDK es ideal para cualquiera que esté aprendiendo o usando tecnología de motores de juego 3D, desde desarrolladores de videojuegos hasta estudiantes. No hay límites." );
				Dictionary.Add( "RedistAMDCPUContent", "" );
				...
				Dictionary.Add( "RedistChartingToolsFail", "No se pudo instalar MSChart." );
				Dictionary.Add( "RedistAMDCPUFail", "No se pudieron instalar los AMD CPU Drivers." );

				Dictionary.Add( "IFDependsFailed", "No se instalaron dependencias; ejecute 'UDK-INSTALL-FOLDER/Binaries/Windows/UE3Redist.exe'." );
				...
				Dictionary.Add( "RedistVCRedistContentTech", "El Paquete Redistribuible Microsoft Visual C++ 2008 SP1  (x86) instala los componentes de tiempo de ejecución de las Bibliotecas Visual C++ necesarios para ejecutar aplicaciones desarrolladas con Visual C++ SP1 en un equipo que no tenga instalado Visual C++ 2008 SP1. Este paquete instala componentes de tiempo de ejecución de las librerías C Runtime (CRT), Standard C++, ATL, MFC, OpenMP y MSDIA." );
				...
				Dictionary.Add( "RedistChartingToolsContentTech", "Microsoft Chart Controls para Microsoft .NET Framework 3.5 SP1 instalará nuevos ensamblados que contienen ASP.NET y Windows Forms Chart Controls." );
			...
			case "ESM":
				...
				Dictionary.Add( "RedistVCRedistHeader", "Redistribuibles de Visual Studio 2008" );
				Dictionary.Add( "RedistDXRedistHeader", "Microsoft DirectX 9.0c" );
				Dictionary.Add( "RedistChartingToolsHeader", "Herramientas de graficación de Microsoft" );
				Dictionary.Add( "RedistAMDCPUHeader", "Controladores de CPU AMD(paso único de XP)" );

				Dictionary.Add( "RedistVCRedistContent", "Puede disponer de los recursos y la documentación de soporte de UDK gratuita en http://www.udk.com/documentation" );
				...
				Dictionary.Add( "RedistChartingToolsContent", "UDK sirve para cualquiera que esté usando o aprendiendo a usar motores de juegos en 3D, desde desarrolladores de juegos a estudiantes. Sin límites." );
				Dictionary.Add( "RedistAMDCPUContent", "" );
				...
				Dictionary.Add( "RedistChartingToolsFail", "Falló la instalación de MSChart." );
				Dictionary.Add( "RedistAMDCPUFail", "Falló la instalación de los controladores de AMD CPU." );

				Dictionary.Add( "IFDependsFailed", "No se instalaron las dependencias; ejecute 'UDK-INSTALL-FOLDER/Binaries/Windows/UE3Redist.exe'" );
				...
				Dictionary.Add( "RedistVCRedistContentTech", "El Paquete Redistribuible de Microsoft Visual C++ 2008 SP1 (x86) instala los componentes en tiempo de ejecución de Visual C++ Libraries necesarios para ejecutar aplicaciones desarrolladas con Visual C++ SP1 en una computadora que no tiene instalado Visual C++ 2008. Este paquete instala componentes en tiempo de ejecución de bibliotecas de C Runtime (CRT), Standard C++, ATL, MFC, OpenMP y MSDIA libraries." );
				...
				Dictionary.Add( "RedistChartingToolsContentTech", "Microsoft Chart Controls para Microsoft.NET Framework 3.5 SP1 instalará nuevos ensamblados que contienen la ASP.NET  y Windows Forms Charts Controls." );
			...
			case "RUS":
				...
				Dictionary.Add( "PrivacyStatement2", "Ознакомьтесь с нашей политикой конфиденциальности: http://udk.com/privacy" );
				...
				Dictionary.Add( "RedistVCRedistHeader", "Redistributables Visual Studio 2008" );
				Dictionary.Add( "RedistDXRedistHeader", "Microsoft DirectX 9.0c" );
				Dictionary.Add( "RedistChartingToolsHeader", "Инструменты для построения диаграмм Microsoft Charting Tools" );
				Dictionary.Add( "RedistAMDCPUHeader", "Драйверы процессоров AMD (шаг только для XP)" );

				Dictionary.Add( "RedistVCRedistContent", "Свободный доступ к сопроводительной документации и ресурсам UDK на http://www.udk.com/documentation" );
				...
				Dictionary.Add( "RedistChartingToolsContent", "UDK предназначен для тех, кто изучает или использует 3D технологию игрового движка, от разработчиков игр до студентов. Не существует никаких ограничений." );
				Dictionary.Add( "RedistAMDCPUContent", "" );
				...
				Dictionary.Add( "RedistChartingToolsFail", "Не удалось установить MSChart." );
				Dictionary.Add( "RedistAMDCPUFail", "Не удалось установить драйверы для процессора AMD." );

				Dictionary.Add( "IFDependsFailed", "Зависимости не установлены; запустите «UDK-INSTALL-FOLDER/Binaries/Windows/UE3Redist.exe»" );
				...
				Dictionary.Add( "RedistVCRedistContentTech", "Пакет Redistributable (x86) Microsoft Visual C++ 2008 SP1 устанавливает компоненты среды выполнения библиотек Visual C++, необходимые для запуска приложений, разработанных с помощью Visual C++ SP1, на компьютере, на котором не установлен пакет Visual C++ 2008 SP1. Этот пакет устанавливает компоненты среды выполнения из библиотек C Runtime (CRT), Standard C++, ATL, MFC, OpenMP и MSDIA." );
				...
				Dictionary.Add( "RedistChartingToolsContentTech", "Microsoft Chart Controls для Microsoft .NET Framework 3.5 SP1 установит новые сборки, которые содержат элементы управления диаграммами ASP.NET и Windows Forms." );
			...
			case "POL":
				...
				Dictionary.Add( "PrivacyStatement2", "Zapoznaj się z naszą Polityką ochrony: http://udk.com/privacy" );
				...
				Dictionary.Add( "RedistVCRedistHeader", "Pakiet redystrybucyjny programu Visual Studio 2008" );
				Dictionary.Add( "RedistDXRedistHeader", "Microsoft DirectX 9.0c" );
				Dictionary.Add( "RedistChartingToolsHeader", "Narzędzia Microsoft Chart" );
				Dictionary.Add( "RedistAMDCPUHeader", "Sterowniki procesora AMD (tylko Windows XP)" );

				Dictionary.Add( "RedistVCRedistContent", "Dokumentacja techniczna i zasoby dotyczące zestawu UDK są dostępne na stronie http://www.udk.com/documentation." );
				...
				Dictionary.Add( "RedistChartingToolsContent", "Zestaw UDK jest przeznaczony dla każdego, niezależnie od tego czy dopiero uczącego się, czy korzystającego już z technologii silników gier trójwymiarowych, od studentów po profesjonalnych twórców gier. Nie ma żadnych ograniczeń." );
				Dictionary.Add( "RedistAMDCPUContent", "" );
				...
				Dictionary.Add( "RedistChartingToolsFail", "Instalacja narzędzi MSChart nie powiodła się." );
				Dictionary.Add( "RedistAMDCPUFail", "Instalacja sterowników procesora AMD nie powiodła się." );

				Dictionary.Add( "IFDependsFailed", "Pakiety zależne nie zostały zainstalowane. Uruchom program „UDK-FOLDER-INSTALACJI/Binaries/Windows/UE3Redist.exe”." );
				...
				Dictionary.Add( "RedistVCRedistContentTech", "Pakiet redystrybucyjny programu Microsoft Visual C++ 2008 SP1 (x86) jest instalowany ze składnikami czasu wykonywania do bibliotek Visual C++ wymaganymi do uruchamiania aplikacji stworzonych w Visual C++ SP1 na komputerze, na którym program Visual C++ 2008 SP1 nie jest zainstalowany. Instalowane są składniki czasu wykonywania do bibliotek C Runtime (CRT), Standard C++, ATL, MFC, OpenMP i MSDIA." );
				...
				Dictionary.Add( "RedistChartingToolsContentTech", "Narzędzia Microsoft Chart dla Microsoft .NET Framework 3.5 SP1 są instalowane z nowymi zestawami, które zawierają formanty ASP.NET i Windows Forms Chart." );
			...
			case "CZE":
				...
				Dictionary.Add( "PrivacyStatement2", "Přečtěte si podmínky na ochranu osobních dat: http://udk.com/privacy" );
				...
				Dictionary.Add( "RedistVCRedistHeader", "Visual Studio 2008 redistributovatelné" );
				Dictionary.Add( "RedistDXRedistHeader", "Microsoft DirectX 9.0c" );
				Dictionary.Add( "RedistChartingToolsHeader", "Microsoft Charting Tools" );
				Dictionary.Add( "RedistAMDCPUHeader", "Ovladače AMD CPU (krok jen u XP)" );

				Dictionary.Add( "RedistVCRedistContent", "Volně přístupná podpůrná dokumentace UDK a zdroje na http://www.udk.com/documentation" );
				...
				Dictionary.Add( "RedistChartingToolsContent", "UDK je pro každého, kdo se učí, nebo používá 3D technologii herního enginu, od vývojářů her po studenty. Neexistují žádné limity." );
				Dictionary.Add( "RedistAMDCPUContent", "" );
				...
				Dictionary.Add( "RedistChartingToolsFail", "Instalace MSChart se nezdařila." );
				Dictionary.Add( "RedistAMDCPUFail", "Instalace ovladačů AMD CPU se nezdařila." );

				Dictionary.Add( "IFDependsFailed", "Nebyly splněny závislosti; prosím spusťte 'UDK-INSTALL-FOLDER/Binaries/Windows/UE3Redist.exe'" );
				...
				Dictionary.Add( "RedistVCRedistContentTech", "Redistributovatelný balíček (x86) Microsoft Visual C++ 2008 SP1 instaluje runtime komponenty knihoven Visual C++, které jsou nutné pro chod aplikací vyvinutých s Visual C++ SP1 na počítači, kde není nainstalovaný Visual C++ 2008 SP1. Tento balíček instaluje runtime komponenty knihoven C Runtime (CRT), Standard C++, ATL, MFC, OpenMP a MSDIA." );
				...
				Dictionary.Add( "RedistChartingToolsContentTech", "Microsoft Chart Controls pro Microsoft .NET Framework 3.5 SP1 nainstalují nové celky, které obsahují ASP.NET a Windows Forms Chart Controls." );
			...
			case "HUN":
				...
				Dictionary.Add( "PrivacyStatement2", "Olvassa el az Adatvédelmi szabályzatunkat: http://udk.com/privacy" );
				...
				Dictionary.Add( "RedistVCRedistHeader", "Visual Studio 2008 Redistributables" );
				Dictionary.Add( "RedistDXRedistHeader", "Microsoft DirectX 9.0c" );
				Dictionary.Add( "RedistChartingToolsHeader", "Microsoft Charting Tools" );
				...
				Dictionary.Add( "RedistChartingToolsContent", "Az UDK-t bárki használhatja, aki a 3D-s játékmotor-technológiával ismerkedik vagy azt használja, a játékfejlesztőktől a hallgatókig. A funkciók nincsenek korlátozva." );
				Dictionary.Add( "RedistAMDCPUContent", "" );
				...
				Dictionary.Add( "RedistChartingToolsFail", "MSChart telepítése sikertelen." );
				Dictionary.Add( "RedistAMDCPUFail", "AMD processzor-illesztőprogramok telepítése sikertelen." );

				Dictionary.Add( "IFDependsFailed", "A függőségek nem lettek telepítve; futtassa az 'UDK-INSTALL-FOLDER/Binaries/Windows/UE3Redist.exe' fájlt" );
				...
				Dictionary.Add( "RedistVCRedistContentTech", "A Microsoft Visual C++ 2008 SP1 Redistributable Package (x86) a Visual C++ Libraries futásidejű összetevőit telepíti, amelyek a Visual C++ SP1 segítségével fejlesztett alkalmazások futtatásához szükségesek olyan számítógépen, amelyen nincs telepítve a Visual C++ 2008 SP1 csomag. Ez a csomag a C Runtime (CRT), Standard C++, ATL, MFC, OpenMP és MSDIA könyvtárak futásidejű összetevőit telepíti." );
				...
				Dictionary.Add( "RedistChartingToolsContentTech", "A Microsoft Chart Controls for Microsoft .NET Framework 3.5 SP1 az ASP.NET és Windows Forms Chart Controls elemeket tartalmazó új kódösszeállításokat telepíti." );
			...
			case "SLO":
				...
				Dictionary.Add( "PrivacyStatement2", "Prečítajte si naše zásady používania osobných údajov: http://udk.com/privacy" );
				...
				Dictionary.Add( "RedistVCRedistHeader", "Redistribuovateľné súbory Visual Studio 2008" );
				Dictionary.Add( "RedistDXRedistHeader", "Microsoft DirectX 9.0c" );
				Dictionary.Add( "RedistChartingToolsHeader", "Microsoft Charting Tools" );
				Dictionary.Add( "RedistAMDCPUHeader", "Ovládače procesora AMD (krok iba XP)" );

				Dictionary.Add( "RedistVCRedistContent", "Bezplatnú dokumentáciu a zdroje UDK nájdete na stránke http://www.udk.com/documentation" );
				...
				Dictionary.Add( "RedistChartingToolsContent", "UDK je pre každého, kto sa učí alebo používa technológiu 3D herného enginu, od vývojárov hier až k študentom. Neexistujú obmedzenia." );
				Dictionary.Add( "RedistAMDCPUContent", "" );
				...
				Dictionary.Add( "RedistChartingToolsFail", "MSChart sa nepodarilo nainštalovať." );
				Dictionary.Add( "RedistAMDCPUFail", "Ovládače procesora AMD sa nepodarilo nainštalovať." );

				Dictionary.Add( "IFDependsFailed", "Závislosti neboli nainštalované; spustite „UDK-INSTALL-FOLDER/Binaries/Windows/UE3Redist.exe”" );
				...
				Dictionary.Add( "RedistVCRedistContentTech", "Redistribuovateľný balík Microsoft Visual C++ 2008 SP1 (x86) nainštaluje súčasti typu runtime knižníc Visual C++ potrebných na spustenie aplikácií vyvinutých pomocou Visual C++ SP1 na počítači, ktorý nemá nainštalovaný Visual C++ 2008 SP1. Tento balík nainštaluje súčasti typu runtime knižníc C Runtime (CRT), Standard C++, ATL, MFC, OpenMP a MSDIA." );
				...
				Dictionary.Add( "RedistChartingToolsContentTech", "Microsoft Chart Controls pre Microsoft .NET Framework 3.5 SP1 nainštaluje nové zostavy, ktoré obsahujú ASP.NET a Windows Forms Chart Controls." );
			...
			case "JPN":
				...
				Dictionary.Add( "PrivacyStatement2", "プライバシーポリシーを読む： http://udk.com/privacy" );
				...
				Dictionary.Add( "RedistChartingToolsContent", "「UDKは初心者の方、またはゲームエンジンテクノロジーをすでにご使用になられている方、ゲーム開発者から学生の方まで幅広くご利用いただけます。 " );
				Dictionary.Add( "RedistAMDCPUContent", "" );
				...
				Dictionary.Add( "RedistChartingToolsFail", "MSChart はインストールに失敗しました。" );
				Dictionary.Add( "RedistAMDCPUFail", "AMD CPU ドライバはインストールに失敗しました。" );

				Dictionary.Add( "IFDependsFailed", "依存性が欠如しています。'UDK-INSTALL-FOLDER/Binaries/Windows/UE3Redist.exe'を実行してください。" );
				...
				Dictionary.Add( "RedistVCRedistContentTech", "Microsoft Visual C++ 2008 SP1 Redistributable Package (x86) は、Visual C++ 2008 SP1 がインストールされていないPC上にて、Visual C++ SP1 で開発されたアプリケーションを実行するため要求されたVisual C++ ライブラリのランタイムコンポーネントをインストールします。このパッケージは、C Runtime (CRT)、 Standard C++、, ATL, MFC、 OpenMP および MSDIA ライブラリのランタイムコンポーネントをインストールします。" );
				...
				Dictionary.Add( "RedistChartingToolsContentTech", "Microsoft Chart Controls for Microsoft .NET Framework 3.5 SP1 は、ASP.NET および Windows Forms Chart Controlsを含んだアセンブリをインストールします。" );
			...
			case "KOR":
				...
				Dictionary.Add( "ErrorMessage", "오류 메시지:" );
				Dictionary.Add( "UDKTrouble", "가능한 솔루션은 다음을 확인해 주십시오:" );
				Dictionary.Add( "RegUDK", "UDK 등록하기" );
				Dictionary.Add( "RegGame", "Game 등록하기" );
				Dictionary.Add( "CleaningUp", "클린업하기" );

				Dictionary.Add( "GQCaptionNoEULA", "EULA를 찾을 수 없습니다." );
				Dictionary.Add( "GQDescNoEULA", "EULA를 찾을 수 없습니다. 설치를 취소합니다." );
				Dictionary.Add( "GQCaptionInstallFail", "설치에 실패하였습니다." );
				Dictionary.Add( "GQCaptionUninstallAllSure", "모든 파일을 삭제하시겠습니까?" );
				Dictionary.Add( "GQDescUninstallAllSure", "제작한 모든 맵 또는 에셋을 포함한 모든 파일이 삭제됩니다. 계속하시겠습니까?" );

				Dictionary.Add( "GQCaptionUninstallComplete", "설치 해제가 완료되었습니다!" );
				Dictionary.Add( "GQDescUninstallComplete", "모든 파일이 성공적으로 삭제되었습니다." );
				Dictionary.Add( "GQCaptionSubscribe", "메일링 목록 구독하기" );
				Dictionary.Add( "GQDescSubscribe", "Unreal Development Kit의 마케팅 및 기술 업데이트를 신청하신 이메일로 구독합니다." );
				...
				Dictionary.Add( "GQDescCorrupt1", "UDK 패키지가 손상되었습니다. 다시 다운로드 받아 주십시오(시그니처를 찾을 수 없음)." );
				Dictionary.Add( "GQDescCorrupt2", "UDK 패키지가 손상되었습니다. 다시 다운로드 받아 주십시오(zip 파일을 여는 도중 예외가 발생함)." );
				Dictionary.Add( "GQCaptionPleaseSetGameName", "Game Name을 설정해 주십시오." );
				Dictionary.Add( "GQDescPleaseSetGameName", "'GameName'과 'GameLongName' 필드에 유효한 문자열을 설정해 주십시오." );

				Dictionary.Add( "ButAccept", "동의함" );
				Dictionary.Add( "ButReject", "거부함" );
				Dictionary.Add( "ButInstall", "설치" );
				Dictionary.Add( "ButUninstall", "설치 해제" );

				Dictionary.Add( "EULATitle", "최종 사용자 사용권 계약서" );
				Dictionary.Add( "EULALegalese", "본인은 UDK 소프트웨어 사용권 계약서를 읽었으며, 이를 이해하고, ‘동의함’ 버튼을 클릭함으로써 계약서의 모든 내용에 동의합니다. 이 승낙은 본 계약서 끝의 서명으로 간주되어야 합니다." );

				Dictionary.Add( "GBInstallLocation", "설치 위치" );
				Dictionary.Add( "GBInstallLocationBrowse", "탐색..." );
				Dictionary.Add( "PrivacyStatement", "[선택 사항] UDK 업데이트 및 뉴스 구독 등록하기." );
				Dictionary.Add( "PrivacyStatement2", "개인정보보호정책 읽기: http://udk.com/privacy" );
				Dictionary.Add( "IOInstallOptionsGame", "다음 옵션을 설치하기: " );

				Dictionary.Add( "UpdateFileManifests", "파일 명세서 업데이트하기" );

				Dictionary.Add( "IFInstallFinished", "설치 완료" );
				Dictionary.Add( "IFInstallContentFinished", "다음의 설치가 완료됨: " );
				Dictionary.Add( "IFLaunch", "시작 " );
				Dictionary.Add( "IFFinished", "완료됨" );

				Dictionary.Add( "UIOLocation", "위치: " );
				Dictionary.Add( "UIOOptionsGame", "다음 옵션의 설치를 해제하기: " );
				Dictionary.Add( "DeletingFiles", "파일 삭제 중" );
				Dictionary.Add( "DeletingShortcuts", "단축키 삭제 중" );
				Dictionary.Add( "UnableDeleteFile", "아마도 다른 응용 프로그램에서 위의 파일이 열어있기 때문에 해당 파일은 삭제될 수 없었습니다." );
				Dictionary.Add( "UnableDeleteFolder", "아마도 다른 응용 프로그램에서 위의 폴더가 열어있기 때문에 해당 폴더는 삭제될 수 없었습니다." );
				Dictionary.Add( "DeleteRetry", "삭제를 다시 시도하시겠습니까?" );

				Dictionary.Add( "PBDecompressing", "파일 압축 해제 중" );
				Dictionary.Add( "PBCompressing", "파일 압축 중" );
				Dictionary.Add( "PBPackaging", "파일 패키기 중" );
				Dictionary.Add( "PBDecompPrereq", "필수 구성 파일의 압축을 해제 중" );
				Dictionary.Add( "PBPackagingPrereqs", "필수 구성 파일 패키지 중" );
				Dictionary.Add( "PBSettingInitial", "최초 실행 준비중…" );

				Dictionary.Add( "RedistPleaseWait", "필수 구성 요소 설치하는 중" );

				Dictionary.Add( "RedistVCRedistHeader", "Visual Studio 2008 재배포 가능 패키지" );
				Dictionary.Add( "RedistDXRedistHeader", "Microsoft DirectX 9.0c" );
				Dictionary.Add( "RedistChartingToolsHeader", "Microsoft Charting Tools" );
				Dictionary.Add( "RedistAMDCPUHeader", "AMD CPU 드라이버" );

				Dictionary.Add( "RedistVCRedistContent", "접속이 필요 없는 UDK 지원 문서 및 리소스는 www.udk.com/documentation에서 찾아볼 수 있습니다." );
				Dictionary.Add( "RedistDXRedistContent", "UDK는 블록버스터 비디오 게임을 제작하는데 사용된 세계 정상급의 동일한 도구를 사용할 수 있는 전체 성능의 Unreal Engine 3를 제공합니다." );
				Dictionary.Add( "RedistChartingToolsContent", "UDK는 게임 개발자에서 학생까지, 3D 게임 엔진 기술을 배우고 또는 사용하고자 하는 모든 사용자용입니다. 제한이 없습니다." );
				Dictionary.Add( "RedistAMDCPUContent", "" );

				Dictionary.Add( "RedistVCRedistx86Fail", "VCRedist x86의 설치가 실패하였습니다." );
				Dictionary.Add( "RedistVCRedistx64Fail", "VCRedist x64의 설치가 실패하였습니다." );
				Dictionary.Add( "RedistDXRedistFail", "DirectX 설치가 실패하였습니다." );
				Dictionary.Add( "RedistChartingToolsFail", "MSChart 설치가 실패하였습니다." );
				Dictionary.Add( "RedistAMDCPUFail", "AMD CPU 드라이버 설치가 실패하였습니다." );

				Dictionary.Add( "IFDependsFailed", "종속 파일들이 설치되지 않았습니다. 'UDK-INSTALL-FOLDER/Binaries/Windows/UE3Redist.exe'를 실행해 주십시오." );
				Dictionary.Add( "GQCaptionInvalidInstall", "설치 위치가 유효하지 않습니다." );
				Dictionary.Add( "GQDescInvalidInstall", "설치 위치가 유효하고 디스크 공간이 충분한지 확인해 주십시오. " );

				Dictionary.Add( "UE3RedistEULALegalese", "본인은 UDK 소프트웨어 라이센스 계약을 읽고, 이해하며, ‘동의함' 버튼을 클릭함으로써 모든 계약 약관에 동의합니다." );
				Dictionary.Add( "NetCodeWarn", "Unreal Development Kit(UDK)는 게임 개발 도구 세트입니다. UDK를 사용하여 제작된 응용 프로그램에는 Epic Games, Inc사에 의해 검증되지 않은 코드가 포함되어 있습니다. 인터넷에서 다운로드 받는 다른 모든 응용 프로그램처럼 다운로드 소스를 믿을 수 있을 경우에만 해당 소프트웨어를 설치하십시오. 귀하의 책임하에 사용하십시오." );

				Dictionary.Add( "ExtractFailCaption", "설치에 실패했습니다." );
				Dictionary.Add( "ExtractFailMessage1", "다음을 제외하고는 모든 파일의 압축 해제에 실패했습니다: " );
				Dictionary.Add( "ExtractFailMessage2", "도움이 필요하시면 http://udk.com/troubleshooting을 방문해 주십시오." );
				Dictionary.Add( "UIODeleteOnly", "원본과 임시 파일(사용자가 생성한 파일이 아님)의 설치를 해제합니다." );
				Dictionary.Add( "UIODeleteAll", "모든 파일(사용자가 생성한 파일 포함)의 설치를 해제합니다." );

				Dictionary.Add( "RedistVCRedistContentTech", "Microsoft Visual C++ 2008 SP1 재배포 가능 패키지(x86)는 Visual C++ 2008 SP1이 설치되지 않은 컴퓨터에서 Visual C++ SP1을 사용하여 개발된 응용 프로그램을 실행하는데 필요한 Visual C++ Libraries의 런타임 구성 요소들을 설치합니다. 본 패키지는 C Runtime(CRT), Standard C++, ATL, MFC, OpenMP, MSDIA 라이브러리의 런타임 구성 요소들을 설치합니다." );
				Dictionary.Add( "RedistDXRedistContentTech", "마이크로소프트 DirectX는 윈도우스 기반의 컴퓨터가 완벽한 색상의 그래픽, 비디오, 3D 애니메이션 및 고품질 오디오 등 멀티미디어적 요소가 풍부한 어플리케이션의 실행 및 디스플레이에 이상적인 플랫폼이 되도록 설계된, 테크놀로지의 집합체입니다 " );
				Dictionary.Add( "RedistChartingToolsContentTech", "Microsoft .NET Framework 3.5 SP1용의 Microsoft Chart Controls는 ASP.NET 및 Windows Forms Chart Controls를 포함하는 새로운 어셈블리를 설치합니다." );
				Dictionary.Add( "RedistAMDCPUContentTech", "순간적인 사용자 성능 필요에 부합하기 위해 시스템이 자동적으로 CPU 속도, 전압, 파워 조합을 조절할 수 있게 하여 줍니다. 이 드라이버는 Windows XP SP2, Windows 2003 SP1 x86 및 x64 에디션에서 AMD Athlon 64 X2 Dual Core 프로세서를 지원합니다." );
			...
			case "CHN":
				...
				Dictionary.Add( "PrivacyStatement2", "阅读我们的隐私声明: http://udk.com/privacy" );
				...
				Dictionary.Add( "RedistVCRedistContent", "请在http://www.udk.com/documentation中访问关于UDK的免费的支持文档和资源。" );
				Dictionary.Add( "RedistDXRedistContent", "UDK为您提供了虚幻引擎3的所有强大功能及用于制作惊人的视频游戏的世界级工具。" );
				Dictionary.Add( "RedistChartingToolsContent", "UDK是为任何学习或使用3D游戏引擎技术的人提供的,从开发人员到学生，没有限制。" );
				Dictionary.Add( "RedistAMDCPUContent", "" );
				...
				Dictionary.Add( "RedistChartingToolsFail", "MSChart安装失败." );
				Dictionary.Add( "RedistAMDCPUFail", "AMD CPU驱动程序安装失败." );

				Dictionary.Add( "IFDependsFailed", "没有安装依赖软件；请运行'UDK-INSTALL-FOLDER/Binaries/Windows/UE3Redist.exe'。" );
				...
				Dictionary.Add( "RedistVCRedistContentTech", "Microsoft Visual C++ 2008 SP1 Redistributable Package (x86)安装了当您在没有安装Visual C++ 2008 SP1的计算机中运行使用Visual C++ SP1开发的程序时所需要的Visual C++ Libraries的运行时系统组件。" );
				...
				Dictionary.Add( "RedistChartingToolsContentTech", "Microsoft Chart Controls for Microsoft .NET Framework 3.5 SP1将会安装包含ASP.NET和Windows Forms Chart Controls的新组件。" );
			...
			default:
				...
				Dictionary.Add( "PrivacyStatement2", "Read our Privacy Policy: http://udk.com/privacy" );
				...
				Dictionary.Add( "RedistVCRedistContent", "Access free UDK support documentation and resources at http://www.udk.com/documentation" );
				...
				Dictionary.Add( "RedistChartingToolsContent", "UDK is for anyone learning or using 3D game engine technology, from game developers to students. There are no limits." );
				Dictionary.Add( "RedistAMDCPUContent", "" );
				...
				Dictionary.Add( "RedistChartingToolsFail", "MSChart failed to install." );
				Dictionary.Add( "RedistAMDCPUFail", "AMD CPU Drivers failed to install." );

				Dictionary.Add( "IFDependsFailed", "Dependencies were not installed; please run 'UDK-INSTALL-FOLDER/Binaries/Windows/UE3Redist.exe'" );
				...
				Dictionary.Add( "RedistVCRedistContentTech", "The Microsoft Visual C++ 2008 SP1 Redistributable Package (x86) installs runtime components of Visual C++ Libraries required to run applications developed with Visual C++ SP1 on a computer that does not have Visual C++ 2008 SP1 installed. This package installs runtime components of C Runtime (CRT), Standard C++, ATL, MFC, OpenMP and MSDIA libraries." );
				...
				Dictionary.Add( "RedistChartingToolsContentTech", "Microsoft Chart Controls for Microsoft .NET Framework 3.5 SP1 will install new assemblies that contain the ASP.NET and Windows Forms Chart Controls." );
