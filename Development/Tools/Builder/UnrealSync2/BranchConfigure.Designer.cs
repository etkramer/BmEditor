namespace UnrealSync2
{
	partial class BranchConfigure
	{
		...
		private void InitializeComponent()
		{
			...
			this.LatestApprovedBuild = new System.Windows.Forms.DataGridViewTextBoxColumn();
			...
			// LatestApprovedBuild
			// 
			this.LatestApprovedBuild.HeaderText = "Promoted Build";
			this.LatestApprovedBuild.Name = "LatestApprovedBuild";
			this.LatestApprovedBuild.ReadOnly = true;
			this.LatestApprovedBuild.ToolTipText = "The latest promoted build in this branch.";
			// 
			// QABuild
			// 
		...
		private System.Windows.Forms.DataGridViewTextBoxColumn LatestApprovedBuild;
