...
<br />
<br />
<asp:Button ID="Button_CISLatency" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="Large" Text="CIS Latency" OnClick="Button_PickChart_Click" />
<br />
<br /><asp:Button ID="Button_ScriptBuildTimes" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="Large" Text="Script Build Times" OnClick="Button_PickChart_Click" />
<br />
<br />   
