...
<body>
    ...
    <center>
        <asp:Label ID="Label_CISMobilePC" runat="server" Height="28px" Font-Bold="True" Font-Names="Arial" Font-Size="Medium" ForeColor="Green">
        <br />
        </asp:Label>
    </center>
    ...
    <center>
        <asp:Label ID="Label_CISNanoPC" runat="server" Height="28px" Font-Bold="True" Font-Names="Arial" Font-Size="Medium" ForeColor="Green">
        <br />
        </asp:Label>
    </center>
        <% Response.Write( Errors["Nano"] ); %>
    <center>
        <asp:Label ID="Label_CISNanoMobilePC" runat="server" Height="28px" Font-Bold="True" Font-Names="Arial" Font-Size="Medium" ForeColor="Green">
        <br />
        </asp:Label>
    </center>
        <% Response.Write( Errors["NanoMobile"] ); %>        
    <center>
    ...
    <center>
        ...
        <% Response.Write( Errors["MobileDevice"] ); %>
    <center>
