...
public partial class BuildStatus : BasePage
{
	...
	private void DisplayGoodBuild( SqlConnection Connection, string Branch, int LastChangeProcessed )
    {
		...
		GoodBuild( Connection, Label_CISMobilePC, Branch, "Mobile", "CIS for MobileGame PC is good and has completed through changelist " );
		...
		GoodBuild( Connection, Label_CISNanoPC, Branch, "Nano", "CIS for NanoGame PC is good and has completed through changelist " );
		GoodBuild( Connection, Label_CISNanoMobilePC, Branch, "NanoMobile", "CIS for NanoMobileGame PC is good and has completed through changelist " );
		GoodBuild( Connection, Label_CISUDKPC, Branch, "UDK", "CIS for UDKGame PC is good and has completed through changelist " );
		GoodBuild( Connection, Label_CISMobile, Branch, "MobileDevice", "CIS for Mobile is good and has completed through changelist " );
	...
	private void DisplayBadBuild( SqlConnection Connection, string Branch, int LastChangeProcessed )
    {
		...
		SelectBuild( Connection, Label_CISMobilePC, Branch, "Mobile", "CIS for MobileGame PC is good and has completed through changelist ", "CIS for MobileGame PC is bad and has completed through changelist " );
		...
		SelectBuild( Connection, Label_CISNanoPC, Branch, "Nano", "CIS for NanoGame PC is good and has completed through changelist ", "CIS for NanoGame PC is bad and has completed through changelist " );
		SelectBuild( Connection, Label_CISNanoMobilePC, Branch, "NanoMobile", "CIS for NanoMobileGame PC is good and has completed through changelist ", "CIS for NanoMobileGame PC is bad and has completed through changelist " );
		...
		SelectBuild( Connection, Label_CISMobile, Branch, "MobileDevice", "CIS for Mobile is good and has completed through changelist ", "CIS for Mobile is bad and has completed through changelist " );
