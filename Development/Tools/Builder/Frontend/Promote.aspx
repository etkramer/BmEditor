  ...
  <form id="form1" runat="server">
    <div>
      ...
      <br />
          ...
          <div>
        <asp:Label ID="LabelInfinityBlade1" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="X-Large"
            Height="36px" Text="Promote Build from UnrealEngine3-InfinityBlade1 branch" Width="720px" ForeColor="BlueViolet">
        </asp:Label>
        <table>
          <asp:Repeater ID="UnrealEngine3InfinityBlade1Repeater" runat="server">
            <ItemTemplate>
              <tr>
                <td>
                  <asp:Label ID="Label" runat="server" Font-Bold="True" Height="26px" ForeColor="Blue" Text=<%# DataBinder.Eval(Container.DataItem, "[\"BuildLabel\"]") %> Width="384px" />
                ...
                <td>
                  <asp:Repeater ID="ChildRepeater" runat="server" DataSource=<%# ( ( DataRowView )Container.DataItem ).Row.GetChildRows( "PseudoRelation" ) %> OnItemCommand="BuilderDBRepeater_PromoteItemCommand_InfinityBlade1" >
			        <itemtemplate>
                      <asp:Button ID="Button_Promote" runat="server" Font-Bold="True" Height="26px" ForeColor="DarkGreen" Width="300px" 
                                CommandName=<%# DataBinder.Eval(Container.DataItem, "[\"CommandID\"]") %>
                                CommandArgument=<%# DataBinder.Eval(Container.DataItem, "[\"BuildLabel\"]") %>
          ...
          <div>
        <asp:Label ID="LabelProjectSword" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="X-Large"
