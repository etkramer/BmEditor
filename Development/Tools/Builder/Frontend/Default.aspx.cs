...
public partial class Default : BasePage
{
    ...
    protected void Button_TriggerBuild_Click( object sender, EventArgs e )
    {
		...
		else if( Pressed.ID.StartsWith( "Button_Nano" ))
		{
			Response.Redirect( "Game.aspx?MinAccess=6000&MaxAccess=6600" + UserDetailArg );
		}
		else if( Pressed.ID.StartsWith( "Button_RiftBeta" ) )
		{
		...
		else if( Pressed.ID.StartsWith( "Button_Mobile" ))
		{
			Response.Redirect( "Game.aspx?MinAccess=8000&MaxAccess=8600" + UserDetailArg );
		}
