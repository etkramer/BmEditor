...
namespace Controller
{
    public class Emailer
    {
        ...
        public void SendRestartedMail()
        {
			...
			Body.Append( "MSVC10 version: " + Parent.MSVC10Version + Environment.NewLine );
        ...
        public void SendTriggeredMail( ScriptParser Builder, int CommandID )
        {
			...
			string Cc = Builder.CarbonCopyAddress + ";" + Builder.BranchDef.BranchAdmin;
			...
			SendMail( To, Cc, Subject, Body.ToString(), true, false, MailPriority.Low );
        }
        ...
        public void SendKilledMail( ScriptParser Builder, int CommandID, int BuildLogID, string Killer )
        {
			...
			SendMail( To, Cc, Subject, Body.ToString(), true, false, MailPriority.High );
        }
        ...
        public void SendFailedMail( ScriptParser Builder, int CommandID, int BuildLogID, string FailureMessage, string LogFileName, string OptionalDistro )
        {
			...
			Body.Append( Environment.NewLine + "Detailed log copied to: " + Properties.Settings.Default.FailedLogLocation.Replace( '/', '\\' ) + "\\" + Builder.BranchDef.Branch + "\\" + LogFileName + Environment.NewLine + Environment.NewLine );
			...
			SendMail( To, Cc, Subject, Body.ToString(), Builder.OfficialBuild, false, MailPriority.High );
        }
        ...
        public void SendSucceededMail( ScriptParser Builder, int CommandID, int BuildLogID, string FinalStatus )
        {
			...
			SendMail( To, Cc, Subject, Body.ToString(), true, false, MailPriority.Normal );
        }
		...
		public void SendSuppressedMail( ScriptParser Builder, int CommandID, int BuildLogID, string Status )
		{
			...
			SendMail( To, Cc, Subject, Body.ToString(), Builder.OfficialBuild, false, MailPriority.Normal );
		}
