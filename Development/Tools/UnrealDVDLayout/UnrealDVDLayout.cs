...
namespace UnrealDVDLayout
{
    public partial class UnrealDVDLayout : Form
    {
		...
		public XboxGameDiscLayout XboxDiscLayout = null;
        ...
        private bool ImportTOCFile( string[] FileNames )
        {
            ...
            foreach( string FileName in FileNames )
            {
                ...
                TableOfContents.Read( FileName, RelativeName, Options.FingerprintName );
            }
			...
			case "xbox360":
				...
				TableOfContents.GetNXEArt( GameName );
				break;
        ...
        public void HandleCommandLine( string[] Arguments )
        {
			...
			case "xbox360":
				...
				UnrealControls.XmlHandler.WriteXml<XboxGameDiscLayout>( XboxDiscLayout, XGDFileName, "http://www.w3.org/2001/XMLSchema-instance" );
