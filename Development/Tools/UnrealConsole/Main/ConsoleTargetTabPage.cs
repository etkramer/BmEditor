...
namespace UnrealConsole
{
	...
	public class ConsoleTargetTabPage : UnrealControls.DynamicTabPage
	{
		...
		void mListView_Filters_ItemChecked(object sender, ItemCheckedEventArgs e)
		{
		...
		/// <param name="sender">The object that initiated the event.</param>
		/// <param name="e">Information about the event.</param>
		void mDocument_LineAdded(object sender, OutputWindowDocumentLineAddedEventArgs e)
		{
		...
		void OnOutputTimer(object sender, EventArgs e)
		{
            if (IsHandleCreated)
            {
