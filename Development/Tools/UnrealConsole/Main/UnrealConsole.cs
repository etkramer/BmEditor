...
namespace UnrealConsole
{
	public partial class UnrealConsoleWindow : Form, IUnrealConsole
	{
		...
		public void CaptureScreenshot()
		{
			...
			if (CurTab != null)
			{
				String PNGOutputPath = (CurTab.Target.ParentPlatform.Type == PlatformType.PS3)
					// The PS3 will prepend a "../Binaries" to whatever path we pass it, so 
					? ""
					// for other platforms we must add a ../Binaries ourselves.
					: Path.Combine("..", "Binaries");
