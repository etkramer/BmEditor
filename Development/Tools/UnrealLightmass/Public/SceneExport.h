...
public:
	...
	/**
	 * Whether to save simple lightmaps in linear space rather than the default gamma space (useful for mobile platforms)
	 */
	UBOOL bSimpleLightmapsStoredInLinearSpace;
...
struct FSceneMaterialSettings
{
	...
	/** Note: This setting is driven from the level's WorldInfo.bUseNormalMapsForSimpleLightMaps option */
