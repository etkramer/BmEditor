...
namespace Lightmass
{
	 ...
	 */
	void FLightMapData2D::Compress(INT DebugSampleIndex, UBOOL bKeepSimpleInLinearSpace, UBOOL bUseFixedScaleForSimple, FLOAT FixedScaleForSimple)
	{
		// make sure the data has been quantized already
		Quantize(DebugSampleIndex, bKeepSimpleInLinearSpace, bUseFixedScaleForSimple, FixedScaleForSimple);
	 ...
	 * Compresses the raw lightmap data to a buffer for writing over Swarm
	 */
	void FLightMapData1D::Compress(INT DebugSampleIndex, UBOOL bKeepSimpleInLinearSpace, UBOOL bUseFixedScaleForSimple, FLOAT FixedScaleForSimple)
	{
		// make sure the data has been quantized already
		Quantize(DebugSampleIndex, bKeepSimpleInLinearSpace, bUseFixedScaleForSimple, FixedScaleForSimple);
	...
	void QuantizeLightSamples(
		...
		UBOOL bKeepSimpleInLinearSpace,
		...
		FLOAT FixedScaleForSimple)
	{
		...
		for (INT SampleIndex = 0; SampleIndex < InLightSamples.Num(); SampleIndex++)
		{
			...
			for (INT CoefficientIndex = 0; CoefficientIndex < LM_NUM_STORED_LIGHTMAP_COEF; CoefficientIndex++)
			{
				for (INT ColorIndex = 0; ColorIndex < 3; ColorIndex++)
				{
					if ((CoefficientIndex == LM_SIMPLE_LIGHTMAP_COEF_INDEX) &&
						(bKeepSimpleInLinearSpace))
					{
	 ...
	 */
	void FLightMapData1D::Quantize(INT DebugSampleIndex, UBOOL bKeepSimpleInLinearSpace, UBOOL bUseFixedScaleForSimple, FLOAT FixedScaleForSimple)
	{
		QuantizeLightSamples(Data, QuantizedData, Scale, DebugSampleIndex, FALSE, bKeepSimpleInLinearSpace, bUseFixedScaleForSimple, FixedScaleForSimple);
	}

	/**
	 * Quantize the full-res FLightSamples into FQuantizedLightSampleDatas
	 */
	void FLightMapData2D::Quantize(INT DebugSampleIndex, UBOOL bKeepSimpleInLinearSpace, UBOOL bUseFixedScaleForSimple, FLOAT FixedScaleForSimple)
	{
		QuantizeLightSamples(Data, QuantizedData, Scale, DebugSampleIndex, TRUE, bKeepSimpleInLinearSpace, bUseFixedScaleForSimple, FixedScaleForSimple);
	}
