...
FxCommandError FxDeveloperCommand::Execute( const FxCommandArgumentList& argList )
{
	...
	{
		FxMsg("Copyright (c) 2002-2010 OC3 Entertainment, Inc. - FaceFX was developed by Jamie Redmond, John Briggs, and Doug Perkowski. - Copyright (c) 2002-2010 OC3 Entertainment, Inc.");
	}
	return CE_Success;
}
