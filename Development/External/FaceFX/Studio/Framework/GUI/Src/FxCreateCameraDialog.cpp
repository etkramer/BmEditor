...
void FxCreateCameraDialog::OnCreateButtonPressed( wxCommandEvent& FxUnused(event) )
{
...
void FxCreateCameraDialog::OnCancelButtonPressed( wxCommandEvent& FxUnused(event) )
{
