...
void FxCreateFaceGraphNodeDialog::OnCreateButtonPressed( wxCommandEvent& FxUnused(event) )
{
...
void FxCreateFaceGraphNodeDialog::OnCancelButtonPressed( wxCommandEvent& FxUnused(event) )
{
	_removeNode();
