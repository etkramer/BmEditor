...
//------------------------------------------------------------------------------
	...
	void ObliteratePhoneme( FxSize phonIndex );
...
//------------------------------------------------------------------------------
	...
	// Proofs the phoneme/word list for any consistancy and corruption issues.
	// Returns false if an "unfixable" issue was found.
	FxBool Proof();
