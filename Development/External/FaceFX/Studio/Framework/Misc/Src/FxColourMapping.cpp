...
// Exports the colour map (for saving in templates).
FxArray<FxColourMapEntry> FxColourMap::ExportColourMap()
{
	return _colourMap;
}
...
{
	arc.SerializeClassVersion("FxColourMap", FxTrue, kCurrentFxColourMapVersion);
	arc << _colourMap;
}
