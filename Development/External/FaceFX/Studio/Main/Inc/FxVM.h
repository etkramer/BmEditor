...
public:
	...
	// Returns the result of the last command to be executed.
	static FxCommandError LastCommandResult( void );
...
protected:
	...
	static FxCommandError _lastCommandResult;

	// Sets the last command result and returns it, to allow for chaining.
	static FxCommandError _setResult(FxCommandError result);
