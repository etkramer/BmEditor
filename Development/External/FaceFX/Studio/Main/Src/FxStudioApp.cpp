...
#else
  wxMessageBox(_("FaceFX has detected that it is running modified source code and has disabled its automatic\n\
                 crash reporting system. If you can reproduce this crash in an unmodified version of FaceFX Studio,\n\
                 please send the detailed reproduction steps and a description of the problem to FaceFX Support at\n\
                 support@oc3ent.com.\n\nThank you,\nFaceFX Support"), _("Crash Information"), wxOK|wxCENTRE|wxICON_ERROR);
#endif // defined(OC3_INTERNAL_BUILD)
}
#endif // __UNREAL__
