...
UNITTEST( FxArray, RemoveInPlace )
{
  OC3Ent::Face::FxArray<OC3Ent::Face::FxInt32> test;
  test.Reserve( 6 );
  test.PushBack( 0 );
  ...
  test.PushBack( 5 );
  CHECK( test.Length() == 6 );
  test.RemoveInPlace( 0 );

  CHECK( test.Length() == 5 );
  CHECK( test[0] == 5 && test[4] == 4 );

  test.RemoveInPlace( test.Length() - 1 );

  CHECK( test.Length() == 4 );
  CHECK( test[0] == 5 && test[3] == 3 );
}

UNITTEST( FxArray, Trim )
{
  OC3Ent::Face::FxArray<OC3Ent::Face::FxInt32> test;
  test.Reserve( 6 );
  test.PushBack( 0 );
  ...
  CHECK( test.Allocated() == 6 );

  test.Trim();
  
  CHECK( test.Allocated() == 4 );
  CHECK( test.Length() == 4 );
  CHECK( test[0] == 5 && test[1] == 1 && test[2] == 2 && test[3] == 3 );
}
