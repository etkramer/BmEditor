...
UNITTEST( FxAnimGroup, GetAnimNameAsCstr )
{
  FxAnimGroup testGroup;
  FxAnim testAnim;
  testAnim.SetName( "testAnim" );
  ...
  CHECK( testGroup.GetAnim(0).GetName() == testAnim.GetName() );
  CHECK( testGroup.GetAnim(0).GetNumAnimCurves() == testAnim.GetNumAnimCurves() );
  CHECK( FxStrcmp(testGroup.GetAnimNameAsCstr(0), "testAnim") == 0 );
}
...
UNITTEST( FxAnimGroup, RemoveAnimByIndex )
{
  FxAnimGroup testGroup;
  FxAnim testAnim;
  testAnim.SetName( "testAnim" );
  ...
  CHECK( testGroup.GetAnim(0).GetName() == testAnim.GetName() );
  CHECK( testGroup.GetAnim(0).GetNumAnimCurves() == testAnim.GetNumAnimCurves() );
  CHECK( testGroup.RemoveAnimByIndex(0) == FxTrue );
  CHECK( testGroup.GetNumAnims() == 0 );
}
