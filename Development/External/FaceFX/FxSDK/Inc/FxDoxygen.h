...
/// - \subpage whatsNew174 "What's new in FaceFX 1.7.4"
...
/// \page whatsNew174 What's New in FaceFX 1.7.4
///
/// \section other Other Changes
/// - Added \ref OC3Ent::Face::FxArray::RemoveInPlace() "FxArray::RemoveInPlace()"
/// - Added \ref OC3Ent::Face::FxArray::RemoveIteratorInPlace() "FxArray::RemoveIteratorInPlace()"
/// - Added \ref OC3Ent::Face::FxArray::Trim() "FxArray::Trim()"
/// - Added test cases for the above.
/// - Added \ref OC3Ent::Face::FxAnimGroup::GetAnimNameAsCstr() "FxAnimGroup::GetAnimNameAsCstr()"
/// - Added \ref OC3Ent::Face::FxAnimGroup::RemoveAnimByIndex() "FxAnimGroup::RemoveAnimByIndex()"
/// - Added \ref OC3Ent::Face::FxAnimGroup::Trim() "FxAnimGroup::Trim()"
/// - Added test cases for the above (except Trim()).
