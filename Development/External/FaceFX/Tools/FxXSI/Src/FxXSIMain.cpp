...
XSIPLUGINCALLBACK CStatus XSILoadPlugin( PluginRegistrar& in_reg )
{
	...
	//File manipulation
	in_reg.RegisterCommand(L"FaceFXOpenActor",L"FaceFXOpenActor");
	in_reg.RegisterCommand(L"FaceFXSaveActor",L"FaceFXSaveActor");
	in_reg.RegisterCommand(L"FaceFXNewActor",L"FaceFXNewActor");
