...
#ifndef FxFastFaceGraphBaker_H__
#define FxFastFaceGraphBaker_H__
...
class FxFastFaceGraphBaker
{
public:
	/// Constructor.
	FxFastFaceGraphBaker( FxActor* pActor = NULL );
	/// Destructor.
	virtual ~FxFastFaceGraphBaker();
