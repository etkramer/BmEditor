...
//------------------------------------------------------------------------------
	...
	public:
		...
		FxMayaBlendShapePlugInfo( const FxMayaBlendShapePlugInfo& other )
			...
			, targetFullName(other.targetFullName)
		...
		FxName targetName;
		// The full name of the actual target (i.e. "blendshape1.Eat")
		FxString targetFullName;
