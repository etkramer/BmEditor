...
MSyntax FxMayaInsertKeyCommand::newSyntax( void )
{
	...
	syntax.addFlag(kFrameFlag, kFrameFlagLong, MSyntax::kDouble);
	syntax.addFlag(kValueFlag, kValueFlagLong, MSyntax::kDouble);
	syntax.addFlag(kSlopeInFlag, kSlopeInFlagLong, MSyntax::kDouble);
	syntax.addFlag(kSlopeOutFlag, kSlopeOutFlagLong, MSyntax::kDouble);
	return syntax;
}
