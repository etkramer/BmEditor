...
EXPGROUP(_NullGroup)
#define BinkVersion "1.99a"      EXPMACRO        
#define BinkMajorVersion    1    EXPMACRO    
#define BinkMinorVersion    9    EXPMACRO    
#define BinkBuildNumber    99    EXPMACRO     
#define BinkCustomization   0    EXPMACRO    
#define BinkDate    "2011-01-04" EXPMACRO    
EXPGROUP(_RootGroup)
...
#if defined( __RADWIN__ ) ||defined (__RADIPHONE__) || defined( __RADXENON__ ) || defined( __RADPS3__ ) || defined( __RADPSP__ ) || defined( __RADLINUX__ )
...
RADEXPFUNC void RADEXPLINK BinkServiceSound( void );
  ...
  RADEXPFUNC BINKSNDOPEN RADEXPLINK BinkOpenOAL(UINTa param); // don't call directly
  #define BinkSoundUseOAL() BinkSetSoundSystem(BinkOpenOAL, 0);
  ...
  RADEXPFUNC BINKSNDOPEN RADEXPLINK BinkOpen3DS(UINTa param); // don't call directly
  #define BinkSoundUse3DSSound() BinkSetSoundSystem(BinkOpen3DS, 0);
...
RADDEFFUNC void RADLINK BinkUseTelemetry( void * context );
RADDEFFUNC void RADLINK BinkUseTmLite( void * context );
