...
//  __RADSEKRIT__ means you're not supposed to know
    ...
    #define __RAD_GCC_VERSION__ (__GNUC__ * 10000 \
      ...
      #define RADRESTRICT __restrict
        ...
        #define RADINLINE __inline
         ...
         !defined(__RADPSP__) && !defined(__RADSEKRIT__) && !defined(__RADPS3__)  && !defined(__RADSPU__) && \
...
#error "RAD.H did not detect your platform.  Define DOS, WINDOWS, WIN32, macintosh, powerpc, or appropriate console."
      ...
      #define RADEXPFUNC RADDEFFUNC
           ...
           defined(__RADPSP__) || defined(__RADSEKRIT__) || defined(__RADPS3__) || \
   ...
   // probably s.b: RAD_DECLARE_ALIGNED(type, name, alignment)
    #if (defined(__RADWII__) || defined(__RADPSP__) || defined(__RADSEKRIT__) || \
...
// Data layout macros
  ...
  #define RR_MEMBER_OFFSET(type,member)  ( (size_t) &(((type *)0)->member) )
