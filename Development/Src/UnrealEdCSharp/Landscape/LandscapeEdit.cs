        ...
        public bool ViewmodeR
        {
            ...
            set
            {
                if (value != this.viewmodeR)
                {
                    ...
                    if (this.ViewmodeR)
                    {
                        this.viewmodeG = this.viewmodeB = this.viewmodeNone = false;
                    }
        ...
        public bool ViewmodeG
        {
            ...
            set
            {
                if (value != this.viewmodeG)
                {
                    ...
                    if (this.ViewmodeG)
                    {
                        this.viewmodeR = this.viewmodeB = this.viewmodeNone = false;
                    }
                    NotifyPropertyChanged("Viewmode");
                }
            }
        ...
        public bool ViewmodeB
        {
            ...
            set
            {
                if (value != this.viewmodeB)
                {
                    ...
                    if (this.ViewmodeB)
                    {
                        this.viewmodeR = this.viewmodeG = this.viewmodeNone = false;
                    }
                    NotifyPropertyChanged("Viewmode");
                }
            }
