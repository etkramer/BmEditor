...
public:
	...
	{
#if defined(_WIN64)
		String^ URLString = "http://udk.com/documentation?editor64&lang=";
#else
		String^ URLString = "http://udk.com/documentation?editor32&lang=";
#endif
		URLString += CLRTools::ToString(appGetLanguageExt());
