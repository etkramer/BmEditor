...
public:
	...
	FPerforceNET(String^ InServerName, String^ InUserName);
	 ...
	 */
	static UBOOL EnsureValidConnection(FString& InOutServerName, FString& InOutUserName, FString& InOutClientSpecName);
...
protected:
	 ...
	 */
	void EstablishConnection(String^ InServerName, String^ InUserName, String^ InClientSpecName);
	...
	static PerforceConstants::LoginResults GetPerforceLogin (String^% InOutPortName, String^% InOutUserName, String^% InOutClientSpecName);
