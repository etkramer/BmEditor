...
public:
	...
	virtual bool QueryJournalEntries( [Out] MGameAssetJournalEntryList^% OutJournalEntries ) = 0;
...
public:
	...
	static bool CreateJournalEntryFromString( String^ Text,  List<String^>^ AllClassNames, [Out] MGameAssetJournalEntry^% OutJournalEntry );
...
public:
	...
	virtual bool QueryJournalEntries( [Out] MGameAssetJournalEntryList^% OutJournalEntries ) override;
...
private:
	...
	bool AddAssetsToLocalCollection( System::String^InTag, Generic::ICollection<System::String^>^ InAssetFullNames );

	/** Removes assets from a local collection */
	bool RemoveAssetsFromLocalCollection( System::String^InTag, Generic::ICollection<System::String^>^ InAssetFullNames );
