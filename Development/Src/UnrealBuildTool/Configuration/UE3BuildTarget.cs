			...
			else if( OutputPath == null )
			{
				...
				switch (Platform)
				{
					...
					case UnrealTargetPlatform.Xbox360:
						{
							...
							string ExecutableName = GetGameName() + Game.GetSubPlatform() + "-Xbox360-" + Configuration.ToString() + ".xex";
							OutputPath = Path.Combine(OutputPath, ExecutableName);
							break;
						}
					case UnrealTargetPlatform.IPhoneSimulator:
						{
							...
							string ExecutableName = GetGameName() + Game.GetSubPlatform() + "-iPhoneSimulator-" + Configuration.ToString();
							OutputPath = Path.Combine(OutputPath, ExecutableName);
							break;
						}
					case UnrealTargetPlatform.IPhoneDevice:
						{
							OutputPath = Path.Combine(OutputPath, "Binaries\\IPhone");
							string ExecutableName = GetGameName() + Game.GetSubPlatform() + "-iPhoneOS-" + Configuration.ToString();
							OutputPath = Path.Combine( OutputPath, ExecutableName );
							break;
						}
