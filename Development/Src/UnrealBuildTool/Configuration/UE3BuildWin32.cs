...
namespace UnrealBuildTool
{
	partial class UE3BuildTarget
	{
        ...
        {            
			...
			// Paths for additional OpenGL headers
			GlobalCPPEnvironment.SystemIncludePaths.Add("../External/OpenGL");

			// Compile and link with glew
			GlobalCPPEnvironment.SystemIncludePaths.Add("../External/glew-1.5.7/include");
			FinalLinkEnvironment.LibraryPaths.Add("../External/glew-1.5.7/lib");
			if (Platform == UnrealTargetPlatform.Win64)
			{
				FinalLinkEnvironment.AdditionalLibraries.Add("glew32s_x64.lib");
			}
			else
			{
				FinalLinkEnvironment.AdditionalLibraries.Add("glew32s_x86.lib");
			}
            ...
            else
            {
				...
				NonGameProjects.Add(new UE3ProjectDesc("OpenGLDrv/OpenGLDrv.vcproj"));
				if (bUseDynamicES2RHI)
				{
