	...
	partial class UE3BuildTarget
	{
        ...
        void SetUpTriovizEnvironment()
        {
			...
			if (UE3BuildConfiguration.bCompileTrioviz && Directory.Exists("../External/DwTriovizSDK/Lib"))
            {
				...
				if (Platform == UnrealTargetPlatform.Xbox360 || Platform == UnrealTargetPlatform.Win32)
				{
                ...
                {
                    FinalLinkEnvironment.LibraryPaths.Add("../External/DwTriovizSDK/Lib/Xenon");
					GlobalCPPEnvironment.Definitions.Add("DWTRIOVIZSDK_XBOX_FRAMEPACKING_1280=1");
                }
                else if (Platform == UnrealTargetPlatform.PS3)
                {
                    FinalLinkEnvironment.LibraryPaths.Add("../External/DwTriovizSDK/Lib/PS3");
					GlobalCPPEnvironment.Definitions.Add("DWTRIOVIZSDK_PS3_FRAMEPACKING_1280=1");
                }
            }
            else
            {
