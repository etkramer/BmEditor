		...
		{	
			...
			else
			{
				...
				else
				{
                    ...
                    string BaseVSToolPath = Environment.GetEnvironmentVariable("VS90COMNTOOLS");
                    if (string.IsNullOrEmpty(BaseVSToolPath))
					{
                        throw new BuildException("Visual Studio 2008 must be installed in order to build this target.");
