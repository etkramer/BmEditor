...
*/
	...
	*/
	virtual void SetMesh(FShader* VertexShader,const FMeshElement& Mesh,const FSceneView& View) const
	{
		...
		const FLOAT LocalToWorldRotDeterminant = Mesh.LocalToWorld.RotDeterminant();
...
IMPLEMENT_VERTEX_FACTORY_TYPE(FGPUSkinVertexFactory, "GpuSkinVertexFactory", TRUE, FALSE, TRUE, FALSE, VER_PERBONEMOTIONBLUR, 0);
...
IMPLEMENT_VERTEX_FACTORY_TYPE(FGPUSkinMorphVertexFactory, "GpuSkinVertexFactory", TRUE, FALSE, TRUE, FALSE, VER_PERBONEMOTIONBLUR, 0);
