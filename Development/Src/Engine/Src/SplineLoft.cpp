...
IMPLEMENT_VERTEX_FACTORY_TYPE(FSplineMeshVertexFactory, "LocalVertexFactory", TRUE, TRUE, TRUE, TRUE, VER_ADDED_SPLINE_MESH_OFFSET, 0);
...
void FSplineMeshVertexFactoryShaderParameters::SetMesh(FShader* VertexShader,const FMeshElement& Mesh,const FSceneView& View) const
{
	FLocalVertexFactoryShaderParameters::SetMesh(VertexShader, Mesh, View);
}
