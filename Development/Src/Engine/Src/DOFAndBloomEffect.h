...
private:
	...
	FShaderResourceParameter SeparateTranslucencyDepthTextureParameter;
...
-----------------------------------------------------------------------------*/
template<UINT NumSamples, UINT DoFQuality> 
...
public:
	...
	static void ModifyCompilationEnvironment(EShaderPlatform Platform, FShaderCompilerEnvironment& OutEnvironment)
	{
		...
		OutEnvironment.Definitions.Set(TEXT("DOF_ALTERNATIVE_MODE"), DoFQuality ? TEXT("1") : TEXT("0"));
	...
	virtual UBOOL Serialize(FArchive& Ar)
	{
		...
		Ar	<< DOFParameters << SceneTextureParameters << BloomScaleAndThresholdParameter
			<< SmallSceneColorTextureParameter << GatherParamsParameter << VelocityTextureParameter;
...
-----------------------------------------------------------------------------*/
template<UINT NumSamples, UINT DoFQuality> 
class TDOFGatherPixelShader :public TDOFAndBloomGatherPixelShader<NumSamples, DoFQuality>
{
	...
	TDOFGatherPixelShader(const ShaderMetaType::CompiledShaderInitializerType& Initializer)
		:	TDOFAndBloomGatherPixelShader<NumSamples, DoFQuality>(Initializer)
	{
	}
...
class TBloomGatherPixelShader :public TDOFAndBloomGatherPixelShader<NumSamples, 0>
{
	...
	TBloomGatherPixelShader(const ShaderMetaType::CompiledShaderInitializerType& Initializer)
		:	TDOFAndBloomGatherPixelShader<NumSamples, 0>(Initializer)
	{
	}
...
-----------------------------------------------------------------------------*/
template<UINT NumSamples> 
class TMotionBlurGatherPixelShader :public TDOFAndBloomGatherPixelShader<NumSamples, 0>
{
...
protected:
	...
	*/
	void RenderGatherPass(FViewInfo& View, EGatherData DestinationData, FSceneRenderTargetIndex FilterColorIndex, FLOAT CustomColorScale, INT Quality = 0, UINT DoFQuality = 0);
