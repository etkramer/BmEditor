...
IMPLEMENT_VERTEX_FACTORY_TYPE(FParticleVertexFactory,"ParticleSpriteVertexFactory",TRUE,FALSE,TRUE,FALSE, VER_SPRITE_SUBUV_VFETCH_SUPPORT,0);
IMPLEMENT_VERTEX_FACTORY_TYPE(FParticleDynamicParameterVertexFactory,"ParticleSpriteVertexFactory",TRUE,FALSE,TRUE,FALSE, VER_SPRITE_SUBUV_VFETCH_SUPPORT,0);
IMPLEMENT_VERTEX_FACTORY_TYPE(FParticlePointSpriteVertexFactory,"ParticleSpriteVertexFactory",TRUE,FALSE,TRUE,FALSE, VER_SPRITE_SUBUV_VFETCH_SUPPORT,0);
