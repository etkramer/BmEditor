...
public:
	...
	*/
	...
	static void ModifyCompilationEnvironment(EShaderPlatform Platform, FShaderCompilerEnvironment& OutEnvironment) 
	{
		// Xbox and PS3 have GOnePassDominantLight == TRUE, and therefore won't be applying dominant shadows in the additive lighting passes
...
void UDominantDirectionalLightComponent::Initialize(const FDominantShadowInfo& InInfo, const TArray<WORD>& InShadowMap)
{
