...
void UPBRuleNodeBase::DrawRuleNode(FLinkedObjectDrawHelper* InHelper, FViewport* Viewport, FCanvas* Canvas, UBOOL bSelected)
{
	...
	FLinkedObjDrawUtils::DrawLinkedObj( Canvas, ObjInfo, *ControlDesc, *Comment, BorderColor, GetRuleNodeTitleColor(), FIntPoint(RulePosX, RulePosY) );
...
UMaterialInstanceConstant* AProcBuilding::GetBuildingParamMIC(AProcBuilding* ScopeBuilding, UMaterialInterface* ParentMat)
{
	...
	UMaterialInstanceConstant* NewMIC = ConstructObject<UMaterialInstanceConstant>(UMaterialInstanceConstant::StaticClass(), this);										
