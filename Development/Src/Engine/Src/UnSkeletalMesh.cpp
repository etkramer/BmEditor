...
void FMultiSizeIndexContainer::RebuildIndexBuffer( const FMultiSizeIndexContainerData& InData )
{
	...
	{
		IndexBuffer->SetupForInstancing( InData.NumVertsPerInstance );
	}
 ...
 */
void FMultiSizeIndexContainer::GetIndexBufferData( FMultiSizeIndexContainerData& OutData )
{
...
*/
void FStaticLODModel::BuildVertexBuffers(class USkeletalMesh* Mesh, UBOOL bUsePackedPosition)
{
	check(Mesh);
