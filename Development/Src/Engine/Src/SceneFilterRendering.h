...
public:
	...
	virtual UBOOL Serialize(FArchive& Ar)
	{
		...
		SampleWeightsParameter.SetShaderParamName(TEXT("SampleWeights"));
...
public:
	...
	void SetParameters(const FSceneView* View, FSamplerStateRHIParamRef SamplerStateRHI,FTextureRHIParamRef TextureRHI)
	{
		...
		{
			SetTextureParameterDirectly(this->GetPixelShader(), VelocityTextureParameter, TStaticSamplerState<SF_Point>::GetRHI(), GSceneRenderTargets.GetVelocityTexture());
		}
	}
...
public:
	...
	virtual UBOOL Serialize(FArchive& Ar)
	{
		...
		SampleOffsetsParameter.SetShaderParamName(TEXT("SampleOffsets"));
