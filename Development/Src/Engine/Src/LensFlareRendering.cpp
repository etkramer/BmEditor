	...
	for (INT ElementIndex = 0; ElementIndex < ElementOrder.Num(); ElementIndex++)
	{
		...
		if (Element)
		{
			...
			if (LookupValues.LFMaterial)
			{
				...
				ConstantVertexData.RadialDist_SourceRatio_Intensity.X = LookupValues.RadialDistance;
				ConstantVertexData.RadialDist_SourceRatio_Intensity.Y = LookupValues.SourceDistance;
