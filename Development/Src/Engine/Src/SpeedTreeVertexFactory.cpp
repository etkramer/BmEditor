...
{
	return (Material->IsUsedWithSpeedTree() || Material->IsSpecialEngineMaterial()) && !Material->IsUsedWithDecals();
}
...
IMPLEMENT_VERTEX_FACTORY_TYPE(FSpeedTreeBillboardVertexFactory, "SpeedTreeBillboardVertexFactory", TRUE, TRUE, TRUE, FALSE, VER_SPEEDTREE_5_INTEGRATION,0);
IMPLEMENT_VERTEX_FACTORY_TYPE(FSpeedTreeBranchVertexFactory, "SpeedTreeBranchVertexFactory", TRUE, TRUE, TRUE, FALSE, VER_SPEEDTREE_5_INTEGRATION,0);
IMPLEMENT_VERTEX_FACTORY_TYPE(FSpeedTreeFrondVertexFactory, "SpeedTreeFrondVertexFactory", TRUE, TRUE, TRUE, FALSE, VER_SPEEDTREE_5_INTEGRATION,0);
IMPLEMENT_VERTEX_FACTORY_TYPE(FSpeedTreeLeafCardVertexFactory, "SpeedTreeLeafCardVertexFactory", TRUE, TRUE, TRUE, FALSE, VER_SPEEDTREE_5_INTEGRATION,0);
IMPLEMENT_VERTEX_FACTORY_TYPE(FSpeedTreeLeafMeshVertexFactory, "SpeedTreeLeafMeshVertexFactory", TRUE, TRUE, TRUE, FALSE, VER_SPEEDTREE_5_INTEGRATION,0);
