...
void FConsoleSupportContainer::AddConsoleSupport(FConsoleSupport* InConsoleSupport)
{
	...
	if (appStricmp(CONSOLESUPPORT_NAME_360, InConsoleSupport->GetConsoleName()) == 0 ||
		appStricmp(CONSOLESUPPORT_NAME_PS3, InConsoleSupport->GetConsoleName()) == 0 ||
		appStricmp(CONSOLESUPPORT_NAME_IPHONE, InConsoleSupport->GetConsoleName()) == 0 ||
		appStricmp(CONSOLESUPPORT_NAME_NGP, InConsoleSupport->GetConsoleName()) == 0)
	{
