...
void FLensFlareVertexFactoryShaderParameters::SetMesh(FShader* VertexShader,const FMeshElement& Mesh,const FSceneView& View) const
{
...
IMPLEMENT_VERTEX_FACTORY_TYPE(FLensFlareVertexFactory,"LensFlareVertexFactory",TRUE,FALSE,FALSE,FALSE, VER_ADDDED_OCCLUSION_PERCENTAGE_EXPRESSION,0);
