...
void UActorFactory::PostEditChangeProperty(FPropertyChangedEvent& PropertyChangedEvent)
{
...
static inline UBOOL IsValidDecalMaterial(UMaterialInterface* MaterialInterface)
{
	if (MaterialInterface)
	{
		...
		UMaterial* BaseSelectedMaterial = MaterialInterface->GetMaterial(MSP_BASE);
