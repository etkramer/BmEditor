...
public:
	...
	void SetMesh(const FPrimitiveSceneInfo* PrimitiveSceneInfo,const FMeshElement& Mesh,const FSceneView& View,UBOOL bBackFace,FVector& InBuiltLightingAndSelectedFlags,FVector2D& InLightMapResolutionScale, UBOOL bTextureMapped)
	{
...
public:
		...
		) const
	{
		...
		PixelShader->SetMesh(PrimitiveSceneInfo, Mesh, View, bBackFace, BuiltLightingAndSelectedFlags, LMResolutionScale, bTextureMapped);	
