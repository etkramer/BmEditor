...
IMPLEMENT_VERTEX_FACTORY_TYPE(FParticleBeamTrailVertexFactory,"ParticleBeamTrailVertexFactory",TRUE,FALSE,TRUE,FALSE, VER_BEAM_TRAIL_DYNAMIC_PARAMETER,0);
IMPLEMENT_VERTEX_FACTORY_TYPE(FParticleBeamTrailDynamicParameterVertexFactory,"ParticleBeamTrailVertexFactory",TRUE,FALSE,TRUE,FALSE, VER_BEAM_TRAIL_DYNAMIC_PARAMETER,0);
