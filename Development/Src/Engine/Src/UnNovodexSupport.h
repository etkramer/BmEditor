...
#if defined(XBOX) || PS3 || IPHONE || ANDROID
#define NX_USE_SDK_STATICLIBS
#endif // XBOX || PS3 || IPHONE || ANDROID
...
#if !defined(IPHONE) && !defined(ANDROID) && !PLATFORM_MACOSX
...
// Mobile platforms and Mac OS X do not yet support PhysX extensions like QuickLoadConvex
#if IPHONE || ANDROID || PLATFORM_MACOSX
