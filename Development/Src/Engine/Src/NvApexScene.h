...
static UBOOL IsValidObjectPathName(const FString& Name)
{
	...
	// Similar to INVALID_OBJECTNAME_CHARACTERS but ignore the . and add \ and #
...
public:
	...
	**/
	virtual UBOOL IsReadyToRender(physx::apex::NxUserRenderer &Renderer,const physx::PxF32 *eyePos) = 0;
    /**
