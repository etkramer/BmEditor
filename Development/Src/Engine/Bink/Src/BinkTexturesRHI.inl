...
static void CopyBufferToTexture(FTexture2DRHIRef Texture,const TArray<BYTE>& Buffer,const UINT Width,const UINT Height)
{
						 ...
						 UBOOL bIsFullscreen)
{
	...
	RHISetBoundShaderState(
		RHICreateBoundShaderState(GBinkVertexDeclaration.VertexDeclarationRHI,StreamStrides,VertexShader->GetVertexShader(),BasePixelShader->GetPixelShader())
		);
