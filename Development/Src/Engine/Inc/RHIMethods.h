...
DEFINE_RHIMETHOD(
	...
	(FVertexDeclarationRHIParamRef VertexDeclaration, DWORD *StreamStrides, FVertexShaderRHIParamRef VertexShader, FHullShaderRHIParamRef HullShader, FDomainShaderRHIParamRef DomainShader, FPixelShaderRHIParamRef PixelShader, FGeometryShaderRHIParamRef GeometryShader),
	(VertexDeclaration, StreamStrides, VertexShader, HullShader, DomainShader, PixelShader, GeometryShader),
	return,
...
DEFINE_RHIMETHOD(
	...
	(UINT Stride,UINT Size,DWORD InUsage,UINT& OutNumInstances),
 ...
 * @param Mesh The mesh element containing the data for rendering the sprite subuv particles
 */
DEFINE_RHIMETHOD(void, DrawPointSpriteParticles, (const FMeshElement& Mesh),(Mesh),,);
