...
FORCEINLINE EMaterialShaderPlatform GetMaterialPlatform(EShaderPlatform ShaderPlatform)
{
	...
	checkSlow(SP_NumPlatforms == 7);
	static const EMaterialShaderPlatform MaterialPlatformTable[] = { MSP_SM3, MSP_SM3, MSP_SM3, MSP_SM3, MSP_SM3, MSP_SM3, MSP_SM3 };
...
public:
	...
	static TArray<FShaderCompileJob*> Jobs;
