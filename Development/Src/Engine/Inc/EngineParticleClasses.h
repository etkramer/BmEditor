...
VERIFY_CLASS_OFFSET_NODIE(UParticleModuleCollision,ParticleModuleCollision,DelayAmount)
...
VERIFY_CLASS_OFFSET_NODIE(UParticleModuleLocationBoneSocket,ParticleModuleLocationBoneSocket,EditorSkelMesh)
