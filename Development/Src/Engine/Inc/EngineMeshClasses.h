...
{
    BITFIELD TAKE_IMPACT_DAMAGE:1;
    BITFIELD IGNORE_POSE_UPDATES:1;
    BITFIELD IGNORE_RAYCAST_CALLBACKS:1;
    BITFIELD IGNORE_CONTACT_CALLBACKS:1;
    BITFIELD USER_FLAG_0:1;
    BITFIELD USER_FLAG_1:1;
    BITFIELD USER_FLAG_2:1;
    BITFIELD USER_FLAG_3:1;
    SCRIPT_ALIGN;
...
struct FNxDestructibleParameters
{
    ...
    BITFIELD bFormExtendedStructures:1;
    INT SupportDepth;
    INT DebrisDepth;
    INT EssentialDepth;
...
VERIFY_CLASS_OFFSET_NODIE(UPrimitiveComponent,PrimitiveComponent,AutoLODOverride)
...
VERIFY_CLASS_OFFSET_NODIE(UPrimitiveComponent,PrimitiveComponent,MassiveLODAttachedPrimitives)
VERIFY_CLASS_OFFSET_NODIE(UPrimitiveComponent,PrimitiveComponent,AutoLODImportanceWeighting)
...
VERIFY_CLASS_OFFSET_NODIE(UPrimitiveComponent,PrimitiveComponent,PerInstanceRandom)
VERIFY_CLASS_OFFSET_NODIE(UPrimitiveComponent,PrimitiveComponent,PerInstanceRandomOverride)
VERIFY_CLASS_OFFSET_NODIE(UPrimitiveComponent,PrimitiveComponent,CullArea)
VERIFY_CLASS_OFFSET_NODIE(UPrimitiveComponent,PrimitiveComponent,CullAreaMultiplier)
...
VERIFY_CLASS_OFFSET_NODIE(UPrimitiveComponent,PrimitiveComponent,ReflectionShadowPlane)
...
VERIFY_CLASS_OFFSET_NODIE(UPrimitiveComponent,PrimitiveComponent,CollisionFilter)
VERIFY_CLASS_OFFSET_NODIE(UPrimitiveComponent,PrimitiveComponent,HeightmapOverrideType)
VERIFY_CLASS_OFFSET_NODIE(UPrimitiveComponent,PrimitiveComponent,QuadTreeEntry)
...
VERIFY_CLASS_OFFSET_NODIE(UPrimitiveComponent,PrimitiveComponent,UmbraId)
VERIFY_CLASS_OFFSET_NODIE(UPrimitiveComponent,PrimitiveComponent,UmbraIdVersion)
...
VERIFY_CLASS_OFFSET_NODIE(UPrimitiveComponent,PrimitiveComponent,PhysXShapeFilterFlags)
...
VERIFY_CLASS_OFFSET_NODIE(UPrimitiveComponent,PrimitiveComponent,OverrideRBPhysScene)
...
VERIFY_CLASS_OFFSET_NODIE(UMeshComponent,MeshComponent,XRayMaterials)
VERIFY_CLASS_OFFSET_NODIE(UMeshComponent,MeshComponent,ScanMaterials)
VERIFY_CLASS_OFFSET_NODIE(UMeshComponent,MeshComponent,ThermalMaterials)
VERIFY_CLASS_OFFSET_NODIE(UMeshComponent,MeshComponent,BatmobileViewMaterials)
VERIFY_CLASS_OFFSET_NODIE(UMeshComponent,MeshComponent,DLCExtraViewMaterials)
...
VERIFY_CLASS_OFFSET_NODIE(UStaticMeshComponent,StaticMeshComponent,LODBakeMaterials)
...
VERIFY_CLASS_OFFSET_NODIE(UInstancedStaticMeshComponent,InstancedStaticMeshComponent,InstancingRandomSeed)
