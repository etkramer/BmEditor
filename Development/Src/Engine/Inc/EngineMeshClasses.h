...
VERIFY_CLASS_OFFSET_NODIE(UPrimitiveComponent,PrimitiveComponent,MotionBlurScale)
...
VERIFY_CLASS_OFFSET_NODIE(UPrimitiveComponent,PrimitiveComponent,PhysMaterialOverrideDropDown)
