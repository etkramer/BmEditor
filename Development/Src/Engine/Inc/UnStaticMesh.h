...
public:
	...
	*/
	...
	/** Serializer. */
	friend FArchive& operator<<(FArchive& Ar,FColorVertexBuffer& VertexBuffer);
...
//	typedef TkDOPTree<class FStaticMeshCollisionDataProvider,WORD>	kDOPTreeType;
	...
	*/
	 ...
	 */
	static void CheckLightMapUVs( UStaticMesh* InStaticMesh, TArray< FString >& InOutAssetsWithMissingUVSets, TArray< FString >& InOutAssetsWithBadUVSets, TArray< FString >& InOutAssetsWithValidUVSets );
...
struct FStaticMeshComponentLODInfo
{
	...
	/** Vertex positions of the vertex override colors, if there are any */
...
/**
  ...
  */
	...
	*/
	...
	void FixupOverrideColorsIfNecessary();

	/** Save off the vertex positions of the source mesh per LOD if necessary */
	void CacheMeshVertexPositionsIfNecessary();
