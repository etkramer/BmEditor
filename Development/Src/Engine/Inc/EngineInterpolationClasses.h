...
VERIFY_CLASS_OFFSET_NODIE(UInterpGroupInst,InterpGroupInst,TrackInst)
...
VERIFY_CLASS_OFFSET_NODIE(UInterpTrackInstFloatProp,InterpTrackInstFloatProp,ResetFloat)
