...
AUTOGENERATE_NAME(AkMusicCallback)
AUTOGENERATE_NAME(AkSoundCallback)
...
AUTOGENERATE_NAME(CalculateUtilityRating)
...
AUTOGENERATE_NAME(DMCCreate)
AUTOGENERATE_NAME(DMCTakeDamage)
...
AUTOGENERATE_NAME(IsValidEnemyTargetFor)
...
AUTOGENERATE_NAME(MatineeSetFaceFXRegister)
...
AUTOGENERATE_NAME(OnAuthorizationComplete)
...
AUTOGENERATE_NAME(OnFacebookRequestComplete)
...
AUTOGENERATE_NAME(OnUserClickedBanner)
AUTOGENERATE_NAME(OnUserClosedAdvertisement)
AUTOGENERATE_NAME(OnWakeRBPhysics)
AUTOGENERATE_NAME(OnWebRequestComplete)
...
AUTOGENERATE_NAME(SetVariableLinkType)
