...
public:
	...
	/** Non-zero if the world contains Landscape components (used to optimize line and point checks) */
	...
	*/
	...
	UBOOL LandscapeLineCheck( FCheckResult& Hit, AActor* Owner, const FVector& End, const FVector& Start, const FVector& Extent, DWORD TraceFlags );
...
// End FNetworkNotify interface
	...
	UBOOL HandleOnlineSubsystemAuth(const FUniqueNetId &NetId, const UBOOL bAccept);
