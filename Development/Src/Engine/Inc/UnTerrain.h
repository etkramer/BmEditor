...
//    DECLARE_CLASS(FTerrainMaterialResource,UMaterial,0,Engine)
	...
	void PostLoad(EMaterialShaderPlatform MatPlatform);
	/** Called before the resource is saved.						 */
	void PreSave(EMaterialShaderPlatform MatPlatform);
...
private:
	 ...
	 */
	INT CompileTerrainMaterial(EMaterialShaderPlatform MatPlatform,EMaterialProperty Property,FMaterialCompiler* Compiler,UTerrainMaterial* TerrainMaterial,UBOOL Highlighted, FColor& HighlightColor) const;
	/**
