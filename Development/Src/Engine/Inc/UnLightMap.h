...
public:
		...
		NumRefs(0) 
	{
		if( GUsingMobileRHI )
		{
			checkf(bAllowDirectionalLightMaps == FALSE, TEXT("Directional lightmaps are not supported on mobile devices. Make sure Engine.ini : [SystemSettings] : DirectionalLightmaps is FALSE for this platform"));
		}
		else
		{
#if CONSOLE 
...
class ULightMapTexture2D: public UTexture2D
{
	...
	/**
	 * Overridden to return FALSE because light maps don't have source art.
	 *
	 * @return	FALSE always because light maps don't have source art.
	 */
	virtual UBOOL HasSourceArt() const { return FALSE; }

	/**
	 * Overridden to not compress source art because light maps don't have source art.
	 */
	virtual void CompressSourceArt() {}

	/**
	 * Overridden to not provide uncompressed source art because light maps don't have source art.
	 *
	...
	/**
	 * Overridden to not set uncompressed source art because light maps don't have source art.
	 *
	...
	/**
	* Overridden to not set compressed source art because light maps don't have source art.
	 *
