...
public:
	 ...
	 */
	void CalculateAttenuatedVolume( UAudioComponent* AudioComponent, const BYTE DistanceModel, const FLOAT Distance, const FLOAT UsedMinRadius, const FLOAT UsedMaxRadius, const FLOAT dBAttenuationAtMax );

	/**
	 * Calculate the high shelf filter value
	 */	
	void CalculateLPFComponent( UAudioComponent* AudioComponent, const FLOAT Distance, const FLOAT UsedLPFMinRadius, const FLOAT UsedLPFMaxRadius );
