...
#define FOREACH_ENUM_EUIDATAPROVIDERFIELDTYPE(op) \
    op(DATATYPE_Property) \
    op(DATATYPE_Provider) \
    op(DATATYPE_RangeProperty) \
    op(DATATYPE_NetIdProperty) \
    op(DATATYPE_Collection) \
    op(DATATYPE_ProviderCollection) 
...
public:
    ...
    UBOOL SetDataStoreFieldValue(const FString& InDataStoreMarkup,const struct FUIProviderFieldValue& InFieldValue,class ULocalPlayer* OwnerPlayer=NULL);
    UBOOL GetDataStoreFieldValue(const FString& InDataStoreMarkup,struct FUIProviderFieldValue& OutFieldValue,class ULocalPlayer* OwnerPlayer=NULL);
    ...
    DECLARE_FUNCTION(execSetDataStoreFieldValue)
    {
        ...
        P_FINISH;
        *(UBOOL*)Result=this->SetDataStoreFieldValue(InDataStoreMarkup,InFieldValue,OwnerPlayer);
    }
...
VERIFY_CLASS_OFFSET_NODIE(UInput,Input,AxisArray)
