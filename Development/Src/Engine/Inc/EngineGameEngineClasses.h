...
public:
    ...
    TMap<FName,FString> TextureCachePathMap;
    ...
    DECLARE_FUNCTION(execGetDLCTextureCachePath)
    {
        P_GET_NAME(TextureCacheName);
        P_GET_STR_REF(Path);
        P_FINISH;
        *(UBOOL*)Result=this->GetDLCTextureCachePath(TextureCacheName,Path);
    }
	 ...
	 */
	void InstallTFCFiles(const FOnlineContent& DLCBundle);
...
public:
    ...
    class UFacebookIntegration* FacebookIntegration;
    FStringNoInit FacebookIntegrationClassName;
    ...
    BITFIELD HACK_UseTickFrequency:1;
    BITFIELD HACK_EnableDMC:1;
    ...
    BITFIELD bEmulateMobileRendering:1;
    ...
    BITFIELD bTriggerTextureStreaming:1;
...
public:
    ...
    void AddTextureStreamingSlaveLoc(FVector InLoc);
    UBOOL BasicSaveObject(class UObject* Obj,const FString& PathName,UBOOL bIsSaveGame,INT Version);
    ...
    DECLARE_FUNCTION(execAddTextureStreamingSlaveLoc)
    {
        ...
        P_FINISH;
        this->AddTextureStreamingSlaveLoc(InLoc);
    }
    DECLARE_FUNCTION(execBasicSaveObject)
    {
        ...
        P_GET_INT(Version);
        P_FINISH;
        *(UBOOL*)Result=this->BasicSaveObject(Obj,PathName,bIsSaveGame,Version);
    }
...
public:
    ...
    class UInGameAdManager* AdManager;
    FStringNoInit InGameAdManagerClassName;
    ...
    DECLARE_FUNCTION(execGetAdManager);
...
struct InGameAdManager_eventOnUserClosedAdvertisement_Parms
{
    InGameAdManager_eventOnUserClosedAdvertisement_Parms(EEventParm)
    {
    }
};
struct InGameAdManager_eventOnUserClickedBanner_Parms
{
    InGameAdManager_eventOnUserClickedBanner_Parms(EEventParm)
    {
    }
};
...
public:
    ...
    TArrayNoInit<FScriptDelegate> ClickedBannerDelegates;
    TArrayNoInit<FScriptDelegate> ClosedAdDelegates;
    ...
    void delegateOnUserClosedAdvertisement()
    {
        ProcessDelegate(ENGINE_OnUserClosedAdvertisement,&__OnUserClosedAdvertisement__Delegate,NULL);
    }
    void delegateOnUserClickedBanner()
    {
        ProcessDelegate(ENGINE_OnUserClickedBanner,&__OnUserClickedBanner__Delegate,NULL);
    }
    void eventInit()
    {
        ProcessEvent(FindFunctionChecked(ENGINE_Init),NULL);
    }
    DECLARE_CLASS(UInGameAdManager,UObject,0,Engine)
...
AUTOGENERATE_FUNCTION(UDownloadableContentManager,-1,execGetDLCTextureCachePath);
...
AUTOGENERATE_FUNCTION(UEngine,-1,execGetFacebookIntegration);
...
AUTOGENERATE_FUNCTION(UGameEngine,-1,execGetAdManager);
...
{ 
	...
	MAP_NATIVE(UDownloadableContentManager, execGetDLCTextureCachePath)
...
{ 
	MAP_NATIVE(UEngine, execGetFacebookIntegration)
...
{ 
	MAP_NATIVE(UGameEngine, execGetAdManager)
...
VERIFY_CLASS_OFFSET_NODIE(AWorldInfo,WorldInfo,HostMigrationTimeout)
...
VERIFY_CLASS_OFFSET_NODIE(UEngine,Engine,GlobalTranslationContext)
VERIFY_CLASS_SIZE_NODIE(UEngine)
VERIFY_CLASS_OFFSET_NODIE(UGameEngine,GameEngine,GPendingLevel)
VERIFY_CLASS_OFFSET_NODIE(UGameEngine,GameEngine,NamedNetDrivers)
VERIFY_CLASS_SIZE_NODIE(UGameEngine)
VERIFY_CLASS_OFFSET_NODIE(UInGameAdManager,InGameAdManager,ClickedBannerDelegates)
VERIFY_CLASS_OFFSET_NODIE(UInGameAdManager,InGameAdManager,__OnUserClosedAdvertisement__Delegate)
