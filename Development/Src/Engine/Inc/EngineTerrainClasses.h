...
public:
    ...
    FStringNoInit LandscapeActorName;
...
public:
    ...
    class ULandscapeComponent* Neighbors_DEPRECATED[8];
...
VERIFY_CLASS_OFFSET_NODIE(ALandscapeProxy,LandscapeProxy,LandscapeComponents)
VERIFY_CLASS_OFFSET_NODIE(ALandscapeProxy,LandscapeProxy,LandscapeActor)
VERIFY_CLASS_SIZE_NODIE(ALandscapeProxy)
VERIFY_CLASS_OFFSET_NODIE(ALandscape,Landscape,LandscapeMaterial)
VERIFY_CLASS_OFFSET_NODIE(ALandscape,Landscape,Proxies)
...
VERIFY_CLASS_OFFSET_NODIE(ULandscapeComponent,LandscapeComponent,Neighbors_DEPRECATED)
