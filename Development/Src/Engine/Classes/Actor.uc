...
class Actor extends StateObject
	abstract
	native
	nativereplication
...
struct native transient TraceHitInfo
{
	...
	var editoronly notforconsole export PrimitiveComponent	HitComponent; // Component of the actor that we hit.
	var Vector2D			PhysMaterialUV;
};
...
{
	var int ChangeFlags;
	var notforconsole native const Pointer PhysShape0;
	var notforconsole native const Pointer PhysShape1;
	var Actor Actor0;
	var Actor Actor1;
	var int PhysFeatureIndex0;
	var int physFeatureIndex1;
	var notforconsole native Pointer PhysData;
};
