...
struct native ParticleSysParam
{
	...
	var		native pointer			VectorArray; // BM
};

var		vector									DynamicLocalSpawnLocation; // BM
...
defaultproperties
{
	...
	IncomingLight=(R=0.0000000,G=0.0000000,B=0.0000000,A=1.0000000) // BM
