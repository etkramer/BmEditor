...
#define MACOSX_DEFAULT_INI_PREFIX TEXT("MacOSX\\MacOSX")
#define MACOSX_INI_PREFIX TEXT("")
...
FString LocalizeProperty( const TCHAR* Section, const ANSICHAR* Key, const TCHAR* Package=TEXT("Properties"), const TCHAR* LangExt=NULL );
#endif
//@}
...
#if __GNUC__ && !PS3 && !IPHONE && !ANDROID
throw (std::bad_alloc)
#endif
{
