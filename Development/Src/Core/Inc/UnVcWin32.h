...
/**
 * We require at least Visual Studio 2008 w/ SP1 to compile
 */
checkAtCompileTime(_MSC_VER >= 1500 && _MSC_FULL_VER >= 150030729, VisualStudio2008_SP1_Required);
 ...
 */ 
#if _MSC_VER > 1500
	#pragma message("Detected compiler newer than Visual Studio 2008, please update min version checking in UnVcWin32.h")
#endif
