...
#define STATS				(UDK || !(SHIPPING_PC_GAME || UE3_LEAN_AND_MEAN || ANDROID || NGP))
#define ALLOW_NON_APPROVED_FOR_SHIPPING_LIB 1  // this is to allow us to link against libs that we can no ship with (e.g. TCR unapproved libs)
#endif
 ...
 */
#ifndef WITH_TTS
#if PS3 || _WIN64 || PLATFORM_MACOSX	//@todo win64: enable once there is a 64 bit version
#define WITH_TTS 0
#else
 ...
 **/
#ifndef WITH_COLLADA
#define WITH_COLLADA (!UE3_LEAN_AND_MEAN)
#endif
 ...
 */
	...
	#if CONSOLE || UDK || UE3_LEAN_AND_MEAN
 ...
 */
	...
	#endif
	#if defined(GFC_BUILD_RELEASE) && defined(GFC_BUILD_DEBUG)
 		#undef GFC_BUILD_DEBUG
 	#endif
#endif
