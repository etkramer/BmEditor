...
{
	P_GET_STRUCT(FInterpCurveInitFloat, FloatCurve);
	P_GET_FLOAT(InVal);
	P_FINISH;
...
{
	P_GET_STRUCT(FInterpCurveInitVector, VectorCurve);
	P_GET_FLOAT(InVal);
	P_FINISH;
...
{
	P_GET_STRUCT(FInterpCurveInitVector2D, Vector2DCurve);
	P_GET_FLOAT(InVal);
	P_FINISH;
