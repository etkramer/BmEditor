...
{
	MALLOC_PROFILER(GMalloc->Exec(TEXT("SNAPSHOTMEMORYTEXT UObject::CollectGarbage START"),*GLog));
	...
	MALLOC_PROFILER(GMalloc->Exec(TEXT("SNAPSHOTMEMORYTEXT UObject::CollectGarbage END"),*GLog));
}
