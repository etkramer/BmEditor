...
void FD3D11DynamicRHI::ReadSurfaceData(FSurfaceRHIParamRef SurfaceRHI,UINT MinX,UINT MinY,UINT MaxX,UINT MaxY,TArray<BYTE>& OutData, FReadSurfaceDataFlags InFlags)
{
	...
	check( SurfaceDesc.Format == GPixelFormats[PF_A8R8G8B8].PlatformFormat
		...
		|| SurfaceDesc.Format == FindSRGBFormat((DXGI_FORMAT)GPixelFormats[PF_A8R8G8B8].PlatformFormat, TRUE )
	...
	if( SurfaceDesc.Format == GPixelFormats[PF_A8R8G8B8].PlatformFormat || SurfaceDesc.Format == FindSRGBFormat((DXGI_FORMAT)GPixelFormats[PF_A8R8G8B8].PlatformFormat, TRUE ) )
	{
