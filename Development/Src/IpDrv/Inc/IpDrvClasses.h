...
VERIFY_CLASS_OFFSET_NODIE(UOnlineTitleFileDownloadMcp,OnlineTitleFileDownloadMcp,ReadTitleFileCompleteDelegates)
VERIFY_CLASS_OFFSET_NODIE(UOnlineTitleFileDownloadMcp,OnlineTitleFileDownloadMcp,__OnReadTitleFileComplete__Delegate)
...
VERIFY_CLASS_OFFSET_NODIE(UOnlineSubsystemCommonImpl,OnlineSubsystemCommonImpl,GameInterfaceImpl)
