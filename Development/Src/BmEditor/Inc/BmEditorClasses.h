...
#define AUTO_INITIALIZE_REGISTRANTS_BMEDITOR \
	...
	GNativeLookupFuncs.Set(FName("ExtractPackagesCommandlet"), GBmEditorUExtractPackagesCommandletNatives); \
	UUIContainerThumbnailRenderer::StaticClass(); \

#endif // BMEDITOR_NATIVE_DEFS

#ifdef NATIVES_ONLY
FNativeFunctionLookup GBmEditorUExtractPackagesCommandletNatives[] = 
{ 
