...
{
public:
	WxMaskedBitmap AddB, PlayReverseB, PlayB, LoopSectionB, StopB, UndoB, RedoB, CurveEdB, SnapB, FitSequenceB, FitToSelectedB, FitLoopB, FitLoopSequenceB, EndOfTrackB;
...
public:
	 ...
	 */
	void AddTrackToCurveEd( FString GroupName, FColor GroupColor, UInterpTrack* InTrack );
...
protected:
	 ...
	 */
	void DisableCameraPostProcessFlags( UInterpTrack* Track, AActor* GroupActor );
