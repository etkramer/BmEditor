...
BEGIN_COMMANDLET(CookPackages,UnrealEd)
	...
	*/
	...
	EAndroidTextureFormat AndroidTextureFormat;
...
BEGIN_CHILD_COMMANDLET(FindStaticMeshCleanIssues,BaseObjectTagGenerator,UnrealEd)
	 ...
	 */
	void ValidateMapList(const TArray<FString>& InMapList, TArray<FString>& OutValidatedList);
