...
public:
	...
	/** Whether to actively listen for file changes or not */
	UBOOL					bListenForFileChanges;
	...
	*/
	...
	UBOOL RemoveAdditiveSequences(TArray<UAnimSequence*>& Sequences, UAnimSet* DestAnimSet);
