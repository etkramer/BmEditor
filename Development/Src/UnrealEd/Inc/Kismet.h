...
public:
	...
	WxMaskedBitmap RenameSequenceB, HideB, ShowB, CurvesB, SearchB, CreateSeqObjB, ZoomToFitB, UpdateB, OpenB;
...
class WxKismetClassSearch : public wxFrame
{
public:
	 ...
	 */
	void AppendResult(const TCHAR* ResultString, UClass* SequenceObjectClass);
...
//	virtual void		SetRootSequence( USequence* Seq );
	 ...
	 */
	virtual void SetBookmark( INT InIndex );
	 ...
	 */
	virtual void JumpToBookmark( INT InIndex );
