...
public:
	...
	*/
	 ...
	 */
#if GB_SUPPORTED
	void SyncBrowserToObjects( TArray<UObject*>& ObjectSet, UBOOL bAlwaysSyncGenericBrowser=TRUE );
#else
	...
	void SyncMaterialToGenericBrowser( void );
...
private:
	...
	*/
	...
	void MenuSwitchProject( wxCommandEvent& In );
	...
	void MenuToggleEnableD3D11( wxCommandEvent& In );
	...
	void MenuGoToForums( wxCommandEvent& In );
	void MenuGoToSwarmSetup( wxCommandEvent& In );
	void MenuStartupTip( wxCommandEvent& In );
	void MenuShowWelcomeScreen( wxCommandEvent& In );
	...
	void UI_MenuToggleEnableD3D11( wxUpdateUIEvent& In );
