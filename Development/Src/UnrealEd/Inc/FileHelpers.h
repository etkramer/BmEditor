...
public:
	 ...
	 */
	static UBOOL AutosaveContentPackages(const FString& AbsoluteAutosaveDir, INT AutosaveIndex);
	 ...
	 */
	static UBOOL PromptToCheckoutPackages(UBOOL bCheckDirty, const TArray<UPackage*>& PackagesToCheckOut, TArray< UPackage* >* OutPackagesNotNeedingCheckout = NULL, const UBOOL bPromptingAfterModify = FALSE );
	 ...
	 */
	static UBOOL IsFilenameValidForSaving( const FString& Filename );
