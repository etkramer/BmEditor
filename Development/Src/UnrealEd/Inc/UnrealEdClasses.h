...
{
public:
    //## BEGIN PROPS GameStatsDBUploader
    struct FGameStatsRemoteDB* DBUploader;
    //## END PROPS GameStatsDBUploader

    virtual void PostProcessStream();
    virtual UBOOL UploadMetadata();
    DECLARE_FUNCTION(execPostProcessStream)
    {
        P_FINISH;
        this->PostProcessStream();
    }
    DECLARE_FUNCTION(execUploadMetadata)
    {
        P_FINISH;
        *(UBOOL*)Result=this->UploadMetadata();
    }
    DECLARE_CLASS(UGameStatsDBUploader,UGameplayEventsHandler,0|CLASS_Config,UnrealEd)
...
struct FGenericBrowserTypeInfo
{
    ...
    FColor BorderColor;
    QWORD RequiredFlags;
    class WxMBGenericBrowserContextBase* ContextMenu;
...
{
public:
    //## BEGIN PROPS GenericBrowserType_AITree
    //## END PROPS GenericBrowserType_AITree

    DECLARE_CLASS(UGenericBrowserType_AITree,UGenericBrowserType,0,UnrealEd)
	virtual void Init();
...
{
public:
    //## BEGIN PROPS GenericBrowserType_DMC
    //## END PROPS GenericBrowserType_DMC

    DECLARE_CLASS(UGenericBrowserType_DMC,UGenericBrowserType,0,UnrealEd)
	virtual void Init();
	virtual UBOOL ShowObjectEditor( UObject* InObject );
...
{
public:
    //## BEGIN PROPS AITreeLabelRenderer
    //## END PROPS AITreeLabelRenderer

    DECLARE_CLASS(UAITreeLabelRenderer,UThumbnailLabelRenderer,0,UnrealEd)
protected:
	/**
...
AUTOGENERATE_FUNCTION(UGameStatsDBUploader,-1,execUploadMetadata);
AUTOGENERATE_FUNCTION(UGameStatsDBUploader,-1,execPostProcessStream);
...
#define AUTO_INITIALIZE_REGISTRANTS_UNREALED \
	...
	UGameStatsDBUploader::StaticClass(); \
	GNativeLookupFuncs.Set(FName("GameStatsDBUploader"), GUnrealEdUGameStatsDBUploaderNatives); \
	UGenericBrowserType::StaticClass(); \
	UGenericBrowserType_AITree::StaticClass(); \
	...
	UGenericBrowserType_DMC::StaticClass(); \
	...
	UAITreeLabelRenderer::StaticClass(); \
...
FNativeFunctionLookup GUnrealEdUGameStatsDBUploaderNatives[] = 
{ 
	MAP_NATIVE(UGameStatsDBUploader, execUploadMetadata)
	MAP_NATIVE(UGameStatsDBUploader, execPostProcessStream)
	{NULL, NULL}
};
...
VERIFY_CLASS_OFFSET_NODIE(UEditorEngine,EditorEngine,MobileFeatures)
...
VERIFY_CLASS_OFFSET_NODIE(UEditorUserSettings,EditorUserSettings,EditorVolumeLevel)
...
VERIFY_CLASS_OFFSET_NODIE(UGameStatsDBUploader,GameStatsDBUploader,DBUploader)
VERIFY_CLASS_SIZE_NODIE(UGameStatsDBUploader)
...
VERIFY_CLASS_SIZE_NODIE(UGenericBrowserType_AITree)
...
VERIFY_CLASS_SIZE_NODIE(UGenericBrowserType_DMC)
...
VERIFY_CLASS_OFFSET_NODIE(AGroupActor,GroupActor,GroupActors)
...
VERIFY_CLASS_SIZE_NODIE(UAITreeLabelRenderer)
