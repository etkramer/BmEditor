...
protected:
	FString							ErrorTypes[MCTYPE_NUM];
	FString							ErrorTypeColumnLabels[MCTYPE_NUM];
	...
	INT								SortColumn;
	UBOOL							ListFilter[MCTYPE_NUM];

	wxCheckBox* CriticalErrorCheckBox;
	wxCheckBox* ErrorCheckBox;
	wxCheckBox* PerfWarningCheckBox;
	wxCheckBox* WarningCheckBox;
	wxCheckBox* NoteCheckBox;
	wxCheckBox* KismetCheckBox;
	wxCheckBox* InfoCheckBox;
