...
class UEditorEngine : public UEngine, public FCallbackEventDevice
{
	...
	BITFIELD				bUseQuickProcBuilding:1;
	...
	*/
	...
	virtual void SelectGroup(AGroupActor* InGroupActor, UBOOL bForceSelection=FALSE) {}
	 ...
	 */
	static void ImportFbxANIMIntoAnimSet( UAnimSet* AnimSet, const TCHAR* Filename, class USkeletalMesh* FillInMesh, UBOOL bImportMorphTracks );
#endif // WITH_FBX
	 ...
	 */
	virtual void PlayMap( FVector* StartLocation = NULL, FRotator* StartRotation = NULL, INT DestinationConsole = -1, INT InPlayInViewportIndex = -1, UBOOL bUseMobilePreview = FALSE );
	 ...
	 * @param	bUseMobilePreview	True to enable mobile preview mode (PC platform only)
	 */
	virtual void PlayOnConsole(INT ConsoleIndex, UBOOL bUseMobilePreview);
