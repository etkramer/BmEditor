...
public:
	...
	/** Returns the number of colors in the copy buffer */
	UINT NumCopiedColors( ) const { return CopiedColors.Num(); }
...
private:
	...
	/** Temporary buffers used when copying/pasteing colors */
	TArray< UINT > CopiedColorNums;
