...
protected:
	...
	/** The DMC_Prototype of the entry that was last right clicked */
	class UDMC_Prototype* RightClickedDMC; 
...
private:
	...
	/** Create DMC */
	void OnCreateDMC( wxCommandEvent& In );
	/** Open DMC tool */
	void OnOpenDMCTool( wxCommandEvent& In );
