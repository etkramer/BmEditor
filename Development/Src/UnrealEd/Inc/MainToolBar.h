...
public:
	...
	enum EPlatformButtons { B_PC=0, B_PCMobilePreview, B_PCMobilePreviewSettings, B_PS3, B_XBox360, B_iOS, B_MAX };
...
private:
	WxMaskedBitmap NewB, OpenB, SaveB, UndoB, RedoB, CutB, CopyB, PasteB, SearchB, FullScreenB, ContentBrowserB, GenericB, KismetB, TranslateB,
		...
		DistributionToggleB, SocketsB, PSysRealtimeLODToggleB, PSysHelperToggleB, MatineeListB, SentinelB, GameStatsVisualizerB, LODLockingB, QuickProcBuildingB;
