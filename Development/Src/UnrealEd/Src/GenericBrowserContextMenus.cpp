...
void WxMBGenericBrowserContext::AppendObjectMenu()
{
	...
	Append(IDMN_ObjectContext_GenerateResourceCollection,*LocalizeUnrealEd("ResourceCollection"),TEXT(""));
	AppendSeparator();
...
WxMBGenericBrowserContext_ParticleSystem::WxMBGenericBrowserContext_ParticleSystem()
{
	...
	Append(IDMN_ObjectContext_ConvertToSeeded,*LocalizeUnrealEd("ConvertToSeeded"),TEXT(""));
	AppendObjectMenu();
}
