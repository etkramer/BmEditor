...
void UMaterialEditorInstanceTimeVarying::CopyToSourceInstance()
{
	...
	// BM2 has no per-material lightmass overrides.
...
void WxCustomPropertyItem_MaterialInstanceTimeVaryingParameter::RenderItemName( wxBufferedPaintDC& RenderDeviceContext, const wxRect& ClientRect )
{
	...
	RenderDeviceContext.DrawText( *DisplayName, CurrentX+( HasNodeFlags(EPropertyNodeFlags::CanBeExpanded) ? 16 : 0 ),ClientRect.y+YOffset );
...
UMaterialInterface* WxMaterialInstanceTimeVaryingEditor::GetSyncObject()
{
