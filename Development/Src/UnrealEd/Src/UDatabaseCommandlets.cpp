...
UBOOL UParticleSystemAuditCommandlet::ProcessReferencedParticleSystems()
{
	...
	SortedPSysList.KeySort<COMPARE_CONSTREF_CLASS(FString,UnPackageUtilities)>();
					...
					if (Emitter != NULL)
					{
						...
						for (INT LODIdx = 0; LODIdx < Emitter->LODLevels.Num(); LODIdx++)
						{
							...
							if (LODLevel != NULL)
							{
								...
								{
									UParticleModuleColorScaleOverLife* CSOLModule = Cast<UParticleModuleColorScaleOverLife>(LODLevel->Modules(ModuleIdx));
									if (CSOLModule != NULL)
									{
...
UBOOL ULensFlareAuditCommandlet::ProcessReferencedLensFlares()
{
	...
	SortedLensFlareList.KeySort<COMPARE_CONSTREF_CLASS(FString,UnPackageUtilities)>();
...
UBOOL UMaterialAuditCommandlet::ProcessReferencedMaterials()
{
	...
	SortedMaterials.KeySort<COMPARE_CONSTREF_CLASS(FString,UnPackageUtilities)>();
...
UBOOL UFindCinematicTexturesCommandlet::ProcessMinedData()
{
	...
	CompleteTexturelist.KeySort<COMPARE_CONSTREF_CLASS(FString,UnPackageUtilities)>();
