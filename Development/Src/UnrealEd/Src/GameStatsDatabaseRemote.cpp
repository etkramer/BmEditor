...
UBOOL FGameStatsRemoteDB::AddPlayerMetadata(const TArray<FPlayerInformation>& PlayerMetadata)
{
	UBOOL bSuccess = TRUE;
	...
	{
		const FPlayerInformation& PlayerInfo = PlayerMetadata(PlayerIter);
...
void UGameStatsDBUploader::UploadEvent(struct FGameEventHeader& GameEvent, struct FPlayerSpawnEvent* GameEventData)
{
	...
	{
		PawnClassName = Reader->PawnClassArray(GameEventData->PawnClassIndex).PawnClassName.ToString();
	}
...
void UGameStatsDBUploader::UploadEvent(struct FGameEventHeader& GameEvent, struct FPlayerKillDeathEvent* GameEventData)
{
	...
	{
		DamageClassName = Reader->DamageClassArray(GameEventData->DamageClassIndex).DamageClassName.ToString();
	}
...
void UGameStatsDBUploader::UploadEvent(struct FGameEventHeader& GameEvent, struct FWeaponIntEvent* GameEventData)
{
	...
	{
		WeaponClassName = Reader->WeaponClassArray(GameEventData->WeaponClassIndex).WeaponClassName.ToString();
	}
...
void UGameStatsDBUploader::UploadEvent(struct FGameEventHeader& GameEvent, struct FProjectileIntEvent* GameEventData)
{
	...
	{
		ProjectileClassName = Reader->ProjectileClassArray(GameEventData->ProjectileClassIndex).ProjectileClassName.ToString();
	}
