...
public:
	WxMBLayerBrowser()
	{
		...
		// Edit menu
		LayerMenu->Append( IDMN_LB_NEW_LAYER, *LocalizeUnrealEd("NewE"), *LocalizeUnrealEd("ToolTip_140") );
		LayerMenu->Append( IDMN_LB_RENAME_LAYER, *LocalizeUnrealEd("RenameE"), *LocalizeUnrealEd("ToolTip_141") );
		LayerMenu->Append( IDMN_LB_DELETE_LAYER, *LocalizeUnrealEd("Delete"), *LocalizeUnrealEd("ToolTip_142") );
		LayerMenu->AppendSeparator();
		LayerMenu->Append( IDMN_LB_ADD_TO_LAYER, *LocalizeUnrealEd("AddSelectedActorsLayer"), *LocalizeUnrealEd("ToolTip_143") );
		LayerMenu->Append( IDMN_LB_DELETE_FROM_LAYER, *LocalizeUnrealEd("DeleteSelectedActorsLayer"), *LocalizeUnrealEd("ToolTip_144") );
		LayerMenu->AppendSeparator();
		LayerMenu->Append( IDMN_LB_SELECT, *LocalizeUnrealEd("SelectActors"), *LocalizeUnrealEd("ToolTip_145") );
		LayerMenu->Append( IDMN_LB_DESELECT, *LocalizeUnrealEd("DeselectActors"), *LocalizeUnrealEd("ToolTip_146") );
		LayerMenu->AppendSeparator();
		LayerMenu->Append( IDMN_LB_ALLLAYERSVISIBLE, *LocalizeUnrealEd("MakeAllLayersVisible"), *LocalizeUnrealEd("ToolTip_146") );
...
BEGIN_EVENT_TABLE( WxLayerBrowser, WxBrowser )
	...
	EVT_LIST_ITEM_ACTIVATED( ID_LB_ActorList, WxLayerBrowser::OnActorListItemClicked )
