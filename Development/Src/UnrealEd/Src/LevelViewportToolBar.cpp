...
static TArray<FShowFlagData>& GetShowFlagMenuItems( )
{
	...
	if(bFirst)
	{
		...
		OutShowFlags.AddItem( FShowFlagData( Id++, "TessellationSF", SHOW_Tessellation, SFG_Advanced ) );
		OutShowFlags.AddItem( FShowFlagData( Id++, "VisualizeDOFLayersSF", SHOW_VisualizeDOFLayers, SFG_PostProcess ) );
		OutShowFlags.AddItem( FShowFlagData( Id++, "SSAOSF", SHOW_SSAO, SFG_PostProcess ) );
		OutShowFlags.AddItem( FShowFlagData( Id++, "VisualizeSSAOSF", SHOW_VisualizeSSAO, SFG_PostProcess ) );
		OutShowFlags.AddItem( FShowFlagData( Id++, "LightShaftsSF", SHOW_LightShafts, SFG_PostProcess ) );
