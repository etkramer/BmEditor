...
BEGIN_EVENT_TABLE(WxDlgLightingResults, WxTrackableDialog)
	...
	EVT_CHECKBOX(IDCB_PERFWARNINGFILTER,		WxDlgLightingResults::OnFilter)
	...
	EVT_UPDATE_UI(IDCB_PERFWARNINGFILTER,		WxDlgLightingResults::OnUpdateFilterUI)
 ...
 */
void WxDlgLightingResults::AddItem(MapCheckType InType, UObject* InObject, const TCHAR* InMessage, MapCheckAction InRecommendedAction, const TCHAR* InUDNPage)
{
