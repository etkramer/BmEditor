...
struct FGFxDataStoreBinding
{
    ...
    FStringNoInit VarPath;
    FStringNoInit ModelId;
    FStringNoInit ControlId;
    BITFIELD bEditable:1;
    TArrayNoInit<FName> CellTags;
    TArrayNoInit<BYTE> ModelIdUtf8;
    TArrayNoInit<BYTE> ControlIdUtf8;
    TScriptInterface<class IUIListElementProvider> ListDataProvider;
    TArrayNoInit<FName> FullCellTags;
    class GFxValue* ModelRef;
    class GFxValue* ControlRef;

    /** Constructors */
    FGFxDataStoreBinding() {}
    FGFxDataStoreBinding(EEventParm)
    {
        appMemzero(this, sizeof(FGFxDataStoreBinding));
    }
};
...
public:
    ...
    TArrayNoInit<class UGFxObject*> ObjectValues;
    ...
    virtual void PublishDataStoreValues();
    ...
    virtual class UGFxObject* CreateObject(const FString& ASClass,class UClass* Type=NULL);
    ...
    DECLARE_FUNCTION(execRefreshDataStoreBindings)
    {
        P_FINISH;
        this->RefreshDataStoreBindings();
    }
    DECLARE_FUNCTION(execPublishDataStoreValues)
    {
        P_FINISH;
        this->PublishDataStoreValues();
    }
    ...
    DECLARE_FUNCTION(execCreateObject)
    {
        ...
        P_GET_OBJECT_OPTX(UClass,Type,NULL);
        P_FINISH;
        *(class UGFxObject**)Result=this->CreateObject(ASClass,Type);
    }
...
AUTOGENERATE_FUNCTION(UGFxMoviePlayer,-1,execPublishDataStoreValues);
...
{ 
	...
	MAP_NATIVE(UGFxMoviePlayer, execPublishDataStoreValues)
